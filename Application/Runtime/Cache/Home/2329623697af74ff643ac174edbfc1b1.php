...
<div toplayer="1" class="prompt-pop pop-style3" style="z-index:<?php echo ($zindex); ?>;width:800px;" id="<?php echo $funcid;?>" url="<?php echo U('MessageTemplet/index'); ?>">

   <div class="title">
       <span class="pop-name"><?php echo $search[id]?'编辑':'新增'; ?>消息模板信息</span>
...
<div class="pop-scroll">
   <div class="screening ">
      <form enctype="multipart/form-data" action="<?php echo U('MessageTemplet/index?func=save'); ?>" id="<?php echo "$funcid"; ?>-Search" method="post">
          ...
          <ul class="form form-mod-new form-column2">
             ...
             <li>
                  <div class="unit-left"><span class="tit"> 信息类型<em class="abe-red mrg_5">*</em></span></div>
                  <div class="unit-mid">
 ...
 $keyvalue = table_MessageTemplet_type(); if(is_array($keyvalue)){ $i = 0; $__LIST__ = $keyvalue; ?>
             ...
             <li>
                  <div class="unit-left"><span class="tit"> 模板代码<em class="abe-red mrg_5">*</em></span></div>
                  <div class="unit-mid">
                       <div class="textbox">
             ...
             <li class="per100">
                  <div class="unit-left"><span class="tit"> 模板名称<em class="abe-red mrg_5">*</em></span></div>
                  <div class="unit-mid">
                       <div class="textbox">
             ...
             <li class="per100">
                  <div class="unit-left"><span class="tit"> 模板内容</span></div>
                  <div class="unit-mid">
                       <textarea class="textarea0" name="content"   ><?php echo $search['content']; ?></textarea>
                      <div class="prompt" style="display:none">
                          <div class="error"><i class="iconfont">&#xe616;</i></div>
                      </div>
                  </div>
             ...
             <li>
                  <div class="unit-left"><span class="tit"> 发送途径</span></div>
                  <div class="unit-mid">
 ...
 $keyvalue = table_MessageTemplet_send(); if(is_array($keyvalue)){ $i = 0; $__LIST__ = $keyvalue; ?>
                                    <?php foreach($__LIST__ as $key=>$item): ++$i; ?>
                                 <option value="<?php echo $item['id']; ?>" <?php if($item['id'] == $search['send']): ?> selected="selected" <?php endif;?>><?php echo $item['name']; ?></option>
                                    <?php endforeach; ?>
                             <?php } ?>
                           </select>
                       </div>
    ...
    <div class="pop-sub abe-txtc" >
               ...
               <input type="button" value="提交" class="btn btn-blue mrg_10 " onclick="return _asr.submit('<?php echo "$funcid"; ?>', '<?php echo "$funcid"; ?>-Search', '<?php echo U("/Home/MessageTemplet/index?func=save&id=$search[id]") ; ?>',''); " />
