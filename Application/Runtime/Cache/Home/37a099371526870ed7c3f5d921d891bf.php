...
<div toplayer="1" class="prompt-pop" style="z-index: <?php echo ($zindex); ?>;" id="<?php echo $funcid;?>"  funcid="<?php echo ($funcid); ?>" last-url="<?php echo ($__last_url); ?>">
   ...
   <div class="title">
       <span class="pop-name">客户地址 - 转有效</span>
...
<div class="pop-scroll">
   <div class="screening ">
    ...
    <div class="pop-sub abe-txtc" >
               ...
               <input type="button" value="提交" class="btn btn-blue mrg_10 " onclick="return _asr.submit('<?php echo "$funcid"; ?>', '<?php echo "$funcid"; ?>-Search', '<?php echo U("/Home/CustomerAddress/index?func=status_on_save&id=$search[id]") ; ?>',''); " />
