...
<div toplayer="1" class="prompt-pop pop-style3" style="z-index:<?php echo ($zindex); ?>;width:800px;" id="<?php echo $funcid;?>" url="<?php echo U('CustomerCategory/index'); ?>">

   <div class="title">
       <span class="pop-name"><?php echo $search[id]?'编辑':'新增'; ?>客户地址信息</span>
...
<div class="pop-scroll">
   <div class="screening ">
      <form enctype="multipart/form-data" action="<?php echo U('CustomerCategory/index?func=save'); ?>" id="<?php echo "$funcid"; ?>-Search" method="post">
          ...
          <ul class="form form-mod-new form-column2">
             ...
             <li>
                  <div class="unit-left"><span class="tit"> 客户</span></div>
                  <div class="unit-mid">
                       <div class="popup">
                            <input  type="text" class="pbtxt txt0" name="parent_id_name" readonly="readonly" value="<?php echo $search['parent_id_name']; ?>">
                            <button type="submit" class="txt-search" onclick="return _asr.popup('Customerer','<?php echo "$funcid"; ?>','<?php echo "$funcid"; ?>-Search','Single','parent_id','parent_id_name'); " <?php if($search["parent_id_name"]): ?> style="display:none"<?php endif; ?> ><i class="iconfont">&#xe60e;</i></button>
             ...
             <li>
                  <div class="unit-left"><span class="tit"> 邮政编码<em class="abe-red mrg_5">*</em></span></div>
                  <div class="unit-mid">
                       <div class="textbox">
             ...
             <li>
                  <div class="unit-left"><span class="tit"> 联系电话<em class="abe-red mrg_5">*</em></span></div>
                  <div class="unit-mid">
                       <div class="textbox">
              ...
              <li>
                  <div class="unit-left"><span class="tit"> 联系人员<em class="abe-red mrg_5">*</em></span></div>
                  <div class="unit-mid">
                      <div class="textbox">
             ...
             <li class="per100">
                  <div class="unit-left"><span class="tit"> 地址</span></div>
                  <div class="unit-mid">
                       <textarea class="textarea0" name="address"   ><?php echo $search['address']; ?></textarea>
                      <div class="prompt" style="display:none">
                          <div class="error"><i class="iconfont">&#xe616;</i></div>
                      </div>
                  </div>
    ...
    <div class="pop-sub abe-txtc" >
               ...
               <input type="button" value="提交" class="btn btn-blue mrg_10 " onclick="return _asr.submit('<?php echo "$funcid"; ?>', '<?php echo "$funcid"; ?>-Search', '<?php echo U("/Home/CustomerAddress/index?func=save&id=$search[id]") ; ?>',''); " />
