...
<div toplayer="1" class="prompt-pop" style="z-index: <?php echo ($zindex); ?>;" id="<?php echo $funcid;?>"  funcid="<?php echo ($funcid); ?>" last-url="<?php echo ($__last_url); ?>">
   ...
   <div class="title">
       <span class="pop-name">交易开单 - 转款项确认</span>
...
<div class="pop-scroll">
   <div class="screening ">
      <form enctype="multipart/form-data" action="<?php echo U('Trade/index?func=confirm_save'); ?>" id="<?php echo "$funcid"; ?>-Search" method="post" verify="1">
          ...
          <ul class="form form-mod-new form-column2">
             ...
             <li>
                  <div class="unit-left"><span class="tit"> 交易确认</span></div>
                  <div class="unit-mid">
 ...
 $keyvalue = table_Trade_confirm_status(); if(is_array($keyvalue)){ $i = 0; $__LIST__ = $keyvalue; ?>
                                 ...
                                 <option value="<?php echo $item['id']; ?>" <?php if($item['id'] == $search['confirm_status']): ?> selected="selected" <?php endif;?>><?php echo $item['name']; ?></option>
                                    <?php endforeach; ?>
                             <?php } ?>
                           </select>
                       </div>
             ...
             <li>
                  <div class="unit-left"><span class="tit"> 确认付款/元</span></div>
                  <div class="unit-mid">
                       <div class="textbox">
                            <input type="text" class="pbtxt txt0" name="confirm_payment"  value="<?php echo $search['confirm_payment']; ?>"  >
                       </div>
                      <div class="prompt" style="display:none">
                          <div class="error"><i class="iconfont">&#xe616;</i></div>
                      </div>
             ...
             <li>
                  <div class="unit-left"><span class="tit"> 确认收款</span></div>
                  <div class="unit-mid">
                       <div class="textbox">
                            <input type="text" class="pbtxt txt0" name="confirm_receive"  value="<?php echo $search['confirm_receive']; ?>"  >
                       </div>
                      <div class="prompt" style="display:none">
                          <div class="error"><i class="iconfont">&#xe616;</i></div>
                      </div>
    ...
    <div class="pop-sub abe-txtc" >
               ...
               <input type="button" value="提交" class="btn btn-blue mrg_10 " onclick="return _asr.submit('<?php echo "$funcid"; ?>', '<?php echo "$funcid"; ?>-Search', '<?php echo U("/Home/Trade/index?func=confirm_save&id=$search[id]") ; ?>',''); " />
