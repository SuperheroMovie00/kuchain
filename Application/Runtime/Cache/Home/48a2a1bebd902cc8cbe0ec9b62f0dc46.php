...
<div toplayer="1" class="prompt-pop pop-style3" style="z-index:<?php echo ($zindex); ?>;width:800px;" id="<?php echo $funcid;?>" url="<?php echo U('Goods/index'); ?>">
    ...
    <div class="title">
        <span class="pop-name"><?php echo $search[id]?'编辑':'新增'; ?>仓库货品别名信息</span>
    ...
    <div class="pop-scroll">
        <div class="screening ">
            <form enctype="multipart/form-data" action="<?php echo U('Goods/index?func=rela_save'); ?>" id="<?php echo "$funcid"; ?>-Search" method="post">
            ...
            <ul class="form form-mod-new form-column2">
                ...
                <li class="per100">
                    <div class="unit-left">货品名称 <em class="abe-red"></em></div>
                    <div class="unit-mid">
                        <div class="textbox">
                            <label class="pbtxt txt0" readonly name="goods_id" value="" verify="" tips="" reglux=""><?php echo $search['goods_name']; ?></label>
                        </div>
                ...
                <li>
                    <div class="unit-left"><span class="tit"> 原规格</span></div>
                    <div class="unit-mid">
                        <div class="textbox">
                            <label class="pbtxt txt0" readonly name="old_style_info" value="" verify="" tips="" reglux=""><?php echo $search['old_style_info']; ?></label>
                        </div>
                        <div class="prompt" style="display:none">
                            <div class="error"><i class="iconfont">&#xe616;</i></div>
                        </div>
                ...
                <li>
                    <div class="unit-left"><span class="tit"> 原材质</span></div>
                    <div class="unit-mid">
                        <div class="textbox">
                            <label class="pbtxt txt0" readonly name="old_materials" value="" verify="" tips="" reglux=""><?php echo $search['old_materials']; ?></label>
                        </div>
                        <div class="prompt" style="display:none">
                            <div class="error"><i class="iconfont">&#xe616;</i></div>
                        </div>
                ...
                <li>
                    <div class="unit-left"><span class="tit"> 原商标</span></div>
                    <div class="unit-mid">
                        <div class="textbox">
                            <label class="pbtxt txt0" readonly name="old_brand" value="" verify="" tips="" reglux=""><?php echo $search['old_brand']; ?></label>
                        </div>
                        <div class="prompt" style="display:none">
                            <div class="error"><i class="iconfont">&#xe616;</i></div>
                        </div>
                ...
                <li>
                    <div class="unit-left"><span class="tit"> 商标</span></div>
                    <div class="unit-mid">
                        <div class="textbox">
    ...
    <div class="pop-sub abe-txtc" >
        ...
        <input type="button" value="提交" class="btn btn-blue mrg_10 " onclick="return _asr.submit('<?php echo "$funcid"; ?>', '<?php echo "$funcid"; ?>-Search', '<?php echo U("/Home/Goods/index?func=rela_save&id=$search[id]") ; ?>',''); " />
