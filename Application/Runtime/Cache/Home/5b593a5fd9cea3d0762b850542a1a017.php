...
<div toplayer="1" class="prompt-pop pop-style3" style="z-index:<?php echo ($zindex); ?>;width:800px;" id="<?php echo $funcid;?>" url="<?php echo U('CustomerCategory/index'); ?>">
   ...
   <div class="title">
       <span class="pop-name"><?php echo $search[id]?'编辑':'新增'; ?>客户分类信息</span>
...
<div class="pop-scroll">
   <div class="screening ">
    ...
    <div class="pop-sub abe-txtc" >
               ...
               <input type="button" value="提交" class="btn btn-blue mrg_10 " onclick="return _asr.submit('<?php echo "$funcid"; ?>', '<?php echo "$funcid"; ?>-Search', '<?php echo U("/Home/CustomerCategory/index?func=save&id=$search[id]") ; ?>',''); " />
