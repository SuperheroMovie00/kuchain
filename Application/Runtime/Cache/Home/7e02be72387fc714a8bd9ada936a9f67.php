...
<div toplayer="1" class="prompt-pop pop-style3" style="z-index:<?php echo ($zindex); ?>;width:800px;" id="<?php echo $funcid;?>" url="<?php echo U('SystemParameter/index'); ?>">
    ...
    <div class="title">
        <span class="pop-name">查看部门信息</span>
        ...
        <div class="screening ">
            ...
            <ul class="form form-mod-new form-column2">
                ...
                <li>
                    ...
                    <div class="unit-mid"><label class="pbtxt txt0"  ><?php echo get_table_Department_type("$search[type]","name",""); ?></label></div>
                </li>
                <li>
                ...
                <li >
                    <div class="unit-left"><span class="tit"> 上级</span></div>
                    <div class="unit-mid"><label class="pbtxt txt0"  ><?php echo $search["parent_id"]; ?></label></div>
                </li>
                ...
                <li>
                    <div class="unit-left"><span class="tit"> 修改时间</span></div>
                    <div class="unit-mid"><label class="pbtxt txt0"  ><?php echo system_format("DT", $search["modify_time"],1); ?><em class="abe-space-sm"></em><?php echo $search["modify_user"]; ?></label></div>
                </li>
                <li>
                    <div class="unit-left"><span class="tit"> 创建时间</span></div>
                    <div class="unit-mid"><label class="pbtxt txt0"  ><?php echo system_format("DT", $search["create_time"],1); ?><em class="abe-space-sm"></em><?php echo $search["create_user"]; ?></label></div>
                </li>
