     ...
     <table border="0" cellspacing="0" cellpadding="0" class="pub-table-par">
        ...
        <tbody>
          ...
          <tr class= "even">
             ...
             <td><?php echo get_table_Company_byID("$search[company_id]","name"); ?></td>&ndash;&gt;
              <th>上级</th>
...
搜索关闭状态，按需要打开 -->
   ...
   <div class="blank30"></div>
    ...
    <?php echo W('Summary/javascript',array('Department'));?>
