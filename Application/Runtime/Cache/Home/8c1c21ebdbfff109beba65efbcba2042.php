...
<div toplayer="1" class="prompt-pop pop-style4" style="z-index:<?php echo ($zindex); ?>" id="<?php echo $funcid;?>" url="<?php echo U('GoodsAlias/index'); ?>">

   <div class="title">
       <span class="pop-name"><?php echo $search[id]?'编辑':'新增'; ?>货品别名信息</span>
...
<div class="pop-scroll">
   <div class="screening ">
      <form enctype="multipart/form-data" action="<?php echo U('GoodsAlias/index?func=save'); ?>" id="<?php echo "$funcid"; ?>-Search" method="post">
          ...
          <ul class="form form-mod-new form-column2">
              <!--<li class="per100" style="display: none">
                  <div class="unit-left"><span class="tit"> 选择商品<em class="abe-red mrg_5">*</em></span></div>
                  <div class="unit-mid">
...
-->
 ...
 $keyvalue = table_GoodsAlias_type(); if(is_array($keyvalue)){ $i = 0; $__LIST__ = $keyvalue; ?>
             ...
             <li class="per100">
                  <div class="unit-left"><span class="tit"> 标准</span></div>
                  <div class="unit-mid">
                       <div class="textbox">
                            <input type="text" class="pbtxt txt0" name="value"  value="<?php echo $search['value']; ?>"  >
                       </div>
                      <div class="prompt" style="display:none">
                          <div class="error"><i class="iconfont">&#xe616;</i></div>
                      </div>
              ...
              <li class="per100">
                  <div class="unit-left"><span class="tit"> 别名</span></div>
                  <div class="unit-mid">
                      <div class="textbox">
                          <input type="text" class="pbtxt txt0" name="alias"  value="<?php echo $search['alias']; ?>"  >
                      </div>
                      <div class="prompt" style="display:none">
                          <div class="error"><i class="iconfont">&#xe616;</i></div>
                      </div>
    ...
    <div class="pop-sub abe-txtc" >
               ...
               <input type="button" value="提交" class="btn btn-blue mrg_10 " onclick="return _asr.submit('<?php echo "$funcid"; ?>', '<?php echo "$funcid"; ?>-Search', '<?php echo U("/Home/GoodsAlias/index?func=save&id=$search[id]") ; ?>',''); " />
...
<script>
   ...
   function <?php echo $funcid;?>_callback(param){
    ...
    <?php echo W('Summary/javascript',array('GoodsAlias'));?>
