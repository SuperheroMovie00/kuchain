...
<div toplayer="1" class="prompt-pop" style="z-index: <?php echo ($zindex); ?>;" id="<?php echo $funcid;?>"  funcid="<?php echo ($funcid); ?>" last-url="<?php echo ($__last_url); ?>">
   ...
   <div class="title">
       <span class="pop-name">交易开单 - 结束回退</span>
...
<div class="pop-scroll">
   <div class="screening ">
      <form enctype="multipart/form-data" action="<?php echo U('Trade/index?func=close_rollback_save'); ?>" id="<?php echo "$funcid"; ?>-Search" method="post" verify="1">
    ...
    <div class="pop-sub abe-txtc" >
               ...
               <input type="button" value="提交" class="btn btn-blue mrg_10 " onclick="return _asr.submit('<?php echo "$funcid"; ?>', '<?php echo "$funcid"; ?>-Search', '<?php echo U("/Home/Trade/index?func=close_rollback_save&id=$search[id]") ; ?>',''); " />
