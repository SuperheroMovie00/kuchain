...
<div toplayer="1" class="prompt-pop pop-style4" style="z-index:<?php echo ($zindex); ?>;" id="<?php echo $funcid;?>" url="<?php echo U('SystemParameter/index'); ?>">

    <div class="title">
        <span class="pop-name"><?php echo $search[id]?'编辑':'新增'; ?>——<?php echo ($search['subcodcode']); ?>——<?php echo ($search['subcodename']); ?></span>
    ...
    <div class="pop-scroll">
        <div class="screening ">
            <form action="<?php echo U('Subcode/index?func=save'); ?>" id="<?php echo "$funcid"; ?>-Search" method="get">
...
-->
                <li style="display: none">
                    <div class="unit-left"><span class="tit"> 类型<em class="abe-red mrg_5">*</em></span></div>
                    <div class="unit-mid">
                        <div class="textbox">
                            <input type="text" class="pbtxt txt0" name="type"  value="<?php echo $search['type']; ?>"  >
                        </div>
                        <div class="prompt" style="display:none">
                            <div class="error"><i class="iconfont">&#xe616;</i></div>
                        </div>
                ...
                <li class="per100">
                    <div class="unit-left"><span class="tit"> 参数</span></div>
                    <div class="unit-mid">
              ...
              <!--  <li>
                    <div class="unit-left"><span class="tit"> 父层</span></div>
                    <div class="unit-mid">
                        <div class="popup">
                            <input  type="text" class="pbtxt txt0" name="parent_id_name" readonly="readonly" value="<?php echo $search['parent_id_name']; ?>">
                            <button type="submit" class="txt-search" onclick="return _asr.popup('Subcode','<?php echo "$funcid"; ?>','<?php echo "$funcid"; ?>-Search','Single','parent_id','parent_id_name'); " <?php if($search["parent_id_name"]): ?> style="display:none"<?php endif; ?> ><i class="iconfont">&#xe60e;</i></button>
...
-->
    ...
    <div class="pop-sub abe-txtc" >
        <input type="button" value="提交" class="btn btn-blue mrg_10 " onclick="return _asr.submit('<?php echo "$funcid"; ?>', '<?php echo "$funcid"; ?>-Search', '<?php echo U("/Home/Subcode/index?func=save&id=$search[id]") ; ?>',''); " />
