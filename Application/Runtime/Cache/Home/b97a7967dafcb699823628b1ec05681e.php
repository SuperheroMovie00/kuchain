        ...
        <div class="table-box">
            <div class="table-in">
                ...
                <table border="0" cellspacing="0" cellpadding="0" class="pub-table-par">
                    ...
                    <tr class= "even">
                        <th>货品分类</th>
                        <td><?php echo get_table_GoodsCategory_byID("$search[category_code]","code","") ; ?></td>
                        <th>分类名称</th>
                        <td><?php echo $search["style_name"]; ?></td>
                        <th>规格代码</th>
            ...
            <div class="table-in">
                ...
                <div class="order-det-ptab">
                    <div class="od-info abe-fl" >
                        <a href="#" onclick="return _asr.tabsheet('<?php echo $funcid;?>', '<?php echo "$funcid"; ?>-Search', 'kehuziliao');" <?php if($search['_tab'] == 'kehuziliao'): ?> class="current"<?php endif;?>>货品分类资料</a>
            ...
            <div class="table-in">
                ...
                <table border="0" cellspacing="0" cellpadding="0" class="pub-table-par pub-table-par-tdc pub-t-faq">
                    <colgroup>
                        ...
                        <col style="width: 80px ;"> <!-- 货品分类类型 -->
                        <col style="width: 80px ;"> <!-- 货品分类代码 -->
                        <col style="width: 100px ;"> <!-- 货品分类简称 -->
                        <col style="width: 100px ;"> <!-- 货品分类全称 -->
                        <col style="width: 80px ;"> <!-- 助记码 -->
                        <col style="width: 80px ;"> <!-- 货品分类分类 -->
                    ...
                    <tr>
                        ...
                        <th>状态</th>
                        <th>货品分类类型</th>
                        <th class="abe-txtl">货品分类代码</th>
                        <th class="abe-txtl">货品分类简称</th>
                        <th class="abe-txtl">货品分类全称</th>
                        <th>助记码</th>
                    ...
                    <td  class=" abe-txtl "><a href="javascript:void(0);" class="vi-blue"  onclick="return _asr.openLink('<?php echo U("/Home/Customer/index?func=view&id=$master[id]"); ?>','<?php echo filterFuncId( U("/Home/Customer/index?func=view&id=$master[id]") ,"");?>', '<?php echo tabTitle("货品分类","$master[code]") ; ?>' ,0); " ><?php echo $master["code"] ; ?></a></td>
