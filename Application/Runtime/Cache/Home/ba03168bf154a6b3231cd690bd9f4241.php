...
<div toplayer="1" class="prompt-pop pop-style3" style="z-index:<?php echo ($zindex); ?>;width:800px;" id="<?php echo $funcid;?>" url="<?php echo U('Org/index'); ?>">

   <div class="title">
       <span class="pop-name"><?php echo $search[id]?'编辑':'新增'; ?>库链联盟机构信息</span>
...
<div class="pop-scroll">
   <div class="screening ">
      <form enctype="multipart/form-data" action="<?php echo U('Org/index?func=save'); ?>" id="<?php echo "$funcid"; ?>-Search" method="post">
          ...
          <ul class="form form-mod-new form-column2">
             ...
             <li>
                  <div class="unit-left"><span class="tit"> 机构类型<em class="abe-red mrg_5">*</em></span></div>
                  <div class="unit-mid">
 ...
 $keyvalue = table_Org_type(); if(is_array($keyvalue)){ $i = 0; $__LIST__ = $keyvalue; ?>
             ...
             <li>
                  <div class="unit-left"><span class="tit"> 机构代码<em class="abe-red mrg_5">*</em></span></div>
                  <div class="unit-mid">
                       <div class="textbox">
             ...
             <li>
                  <div class="unit-left"><span class="tit"> 机构名称<em class="abe-red mrg_5">*</em></span></div>
                  <div class="unit-mid">
                       <div class="textbox">
             ...
             <li>
                  ...
                  <div class="unit-mid">
                       <div class="textbox">
                            <input type="text" class="pbtxt txt0" name="contacts"  value="<?php echo $search['contacts']; ?>"  >
                       </div>
                      <div class="prompt" style="display:none">
                          <div class="error"><i class="iconfont">&#xe616;</i></div>
                      </div>
             ...
             <li>
                  <div class="unit-left"><span class="tit"> 接口控制</span></div>
                  <div class="unit-mid">
                       <div class="dropdown" id="<?php echo ($funcid); ?>_interface_open">
                           <select class="pbsele dropdown0" name="interface_open">
                             <?php
 $keyvalue = table_Org_interface_open(); if(is_array($keyvalue)){ $i = 0; $__LIST__ = $keyvalue; ?>
                                    <?php foreach($__LIST__ as $key=>$item): ++$i; ?>
                                 <option value="<?php echo $item['id']; ?>" <?php if($item['id'] == $search['interface_open']): ?> selected="selected" <?php endif;?>><?php echo $item['name']; ?></option>
                                    <?php endforeach; ?>
                             <?php } ?>
                           </select>
                       </div>
             ...
             <li>
                  <div class="unit-left"><span class="tit"> 接口类型</span></div>
                  <div class="unit-mid">
 ...
 $keyvalue = table_Org_interface_type(); if(is_array($keyvalue)){ $i = 0; $__LIST__ = $keyvalue; ?>
                                    <?php foreach($__LIST__ as $key=>$item): ++$i; ?>
                                 <option value="<?php echo $item['id']; ?>" <?php if($item['id'] == $search['interface_type']): ?> selected="selected" <?php endif;?>><?php echo $item['name']; ?></option>
                                    <?php endforeach; ?>
                             <?php } ?>
                           </select>
                       </div>
    ...
    <div class="pop-sub abe-txtc" >
               ...
               <input type="button" value="提交" class="btn btn-blue mrg_10 " onclick="return _asr.submit('<?php echo "$funcid"; ?>', '<?php echo "$funcid"; ?>-Search', '<?php echo U("/Home/Org/index?func=save&id=$search[id]") ; ?>',''); " />
