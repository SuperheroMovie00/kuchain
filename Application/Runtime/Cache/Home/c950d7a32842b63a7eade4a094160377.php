...
<div class="prompt-pop pop-style2" id="<?php echo ($funcid); ?>" style="z-index:<?php echo ($zindex); ?>">
    ...
    <div class="title"><span class="pop-name">选择客户分类</span><a href="javascript:void(0);" class="close iconfont" onclick="_asr.closePopup('<?php echo ($funcid); ?>');">&#xe60d;</a> </div>
    ...
    <script>
        function <?php echo ($funcid); ?>_show(_t) {
            ...
            _this.attr("expand", "1");
            var url = "<?php echo U('/Home/Popup/index?func=CustomerCategory&excludeId='.$excludeId.'&selecttype='.$selecttype.'&onlyData=1');?>";
