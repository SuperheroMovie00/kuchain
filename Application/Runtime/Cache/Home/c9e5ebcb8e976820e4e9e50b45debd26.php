...
<div toplayer="1" class="prompt-pop pop-style3" style="z-index:<?php echo ($zindex); ?>;width:800px;" id="<?php echo $funcid;?>" url="<?php echo U('Warehouse/index'); ?>">

   <div class="title">
       <span class="pop-name"><?php echo $search[id]?'编辑':'新增'; ?>仓库信息信息</span>
...
<div class="pop-scroll">
   <div class="screening ">
      <form enctype="multipart/form-data" action="<?php echo U('Warehouse/index?func=save'); ?>" id="<?php echo "$funcid"; ?>-Search" method="post">
          ...
          <ul class="form form-mod-new form-column2">
             ...
             <li>
                  <div class="unit-left"><span class="tit"> 仓库编码<em class="abe-red mrg_5">*</em></span></div>
                  <div class="unit-mid">
                       <div class="textbox">
             ...
             <li>
                  <div class="unit-left"><span class="tit"> 仓库名称<em class="abe-red mrg_5">*</em></span></div>
                  <div class="unit-mid">
                       <div class="textbox">
             ...
             <li>
                  ...
                  <div class="unit-mid">
                      ...
                      <input type="hidden" name="org_id" value="<?php echo $search['org_id']; ?>">
                      <div class="prompt" style="display:none">
                          <div class="error"><i class="iconfont">&#xe616;</i></div>
                      </div>
                  </div>
    ...
    <div class="pop-sub abe-txtc" >
               ...
               <input type="button" value="提交" class="btn btn-blue mrg_10 " onclick="return _asr.submit('<?php echo "$funcid"; ?>', '<?php echo "$funcid"; ?>-Search', '<?php echo U("/Home/Warehouse/index?func=save&id=$search[id]") ; ?>',''); " />
