...
<div toplayer="1" class="prompt-pop pop-style3" style="z-index:<?php echo ($zindex); ?>;width:800px;" id="<?php echo $funcid;?>" url="<?php echo U('GoodsCategory/index'); ?>">
                    ...
                    <div class="unit-mid">
                        <?php if($search["id"] > 0): ?><div class="textbox">
                            ...
                            <div class="popup">
                                ...
                                <button type="submit" class="txt-search" onclick="return _asr.popup('GoodsCategory','<?php echo "$funcid"; ?>','<?php echo "$funcid"; ?>-Search','Single','parent_id_code','parent_id_name'); " <?php if($search["parent_id_name"]): ?> style="display:none"<?php endif; ?> ><i class="iconfont">&#xe60e;</i></button>
 ...
 $keyvalue = table_QuestionCategory_onlyone(); if(is_array($keyvalue)){ $i = 0; $__LIST__ = $keyvalue; ?>
    ...
    <div class="pop-sub abe-txtc" >
        ...
        <input type="button" value="提交" class="btn btn-blue mrg_10 " onclick="return _asr.submit('<?php echo "$funcid"; ?>', '<?php echo "$funcid"; ?>-Search', '<?php echo U("/Home/GoodsCategory/index?func=save&id=$search[id]") ; ?>',''); " />
