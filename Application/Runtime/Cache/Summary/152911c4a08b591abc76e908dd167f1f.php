...
<div toplayer="1" class="wrap-box wrap-nmd wrap-style00 " id="<?php echo $funcid;?>" summaryid="OrgSummary" baseurl="<?php echo U('OrgSummary/index'); ?>">
  <div class="wrap-box-info ">

    <div class="wrap-title abe-ofl">
      <div class="tit abe-fl" style="width: 450px;">库联联盟机构列表</div>
      <div class="abe-fl">
        <div class="textbox" >
          <div  id="<?php echo "$funcid"; ?>-keyword-info" class="abe-fl"<?php if($search["_showsearch"]=="show"):?>style="display:none;"<?php endif; ?>>
             ...
             <input type="button" value="搜索" class="btn btn-org  mrg_10 " id="<?php echo $funcid;?>-keyword-search"  default-status="1"  onclick="<?php echo ($funcid); ?>_keyword_set(); return _asr.submit('<?php echo "$funcid"; ?>', '<?php echo "$funcid"; ?>-Search', '<?php echo U("OrgSummary/index?func=search&") ; ?>',''); " />
             <input id="<?php echo $funcid;?>-search-buttc" type="button" value="导出" class="btn btn-blue mrg_10 " default-status="1" onclick="return _asr.showExport('<?php echo "$funcid"; ?>', '<?php echo "$funcid"; ?>-Search', '<?php echo U("OrgSummary/index?func=export&") ; ?>',<?php echo $p ?>); " />
          </div>
      ...
      <div class="abe-fr">
        <a href="javascript:void(0);" class="mrg_15 vi-blue search-hide" <?php if($search["_showsearch"]=="hide"):?>style="display:none;"<?php endif; ?>><i class="iconfont">&#xe673;</i>收起搜索</a>
          ...
          <?php if (isset($rights['add']) && $rights['add']): ?>
               <input type="button" value="新增库联联盟机构" class="btn btn-blue mrg_10 " onclick="return _asr.popupFun('<?php echo U("/Home/Org/index?func=add&%addlink%") ; ?>', '<?php echo filterFuncId("/Home/Org/index?func=add&%addlink%","");?>'); " />
          <?php endif; ?>
    ...
    <div class="screening"  >
      <form action="<?php echo U('OrgSummary/index?func=search'); ?>" id="<?php echo "$funcid"; ?>-Search" method="get">
                  ...
                  <li>
                      ...
                      <div class="unit-mid">
                          <div class="dropdown" id="<?php echo ($funcid); ?>_status">
                           ...
                           <?php $keyvalue = table_Org_status(); if(is_array($keyvalue)){ $i = 0; $__LIST__ = $keyvalue; ?>
                      ...
                      <div class="unit-mid">
                          <div class="dropdown" id="<?php echo ($funcid); ?>_type">
                             <select class="pbsele dropdown0" name="type">
                               ...
                               <?php
 $keyvalue = table_Org_type(); if(is_array($keyvalue)){ $i = 0; $__LIST__ = $keyvalue; ?>
                                      <?php foreach($__LIST__ as $key=>$item): ++$i; ?>
                  ...
                  <li>
                      ...
                      <div class="unit-mid">
                          <div class="textbox">
                              <input type="text" class="pbtxt txt0" name="contacts"  value="<?php echo $search['contacts']; ?>"   placeholder=" 输入%可进行匹配模糊搜索 ">
                          </div>
                          <div class="prompt" style="display:none">
                              <div class="error"><i class="iconfont">&#xe616;</i></div>
                          </div>
                  ...
                  <li>
                      <div class="unit-left"> 接口控制</div>
                      <div class="unit-mid">
                          <div class="dropdown" id="<?php echo ($funcid); ?>_interface_open">
                             <div class="selebtn">
                                <input type="hidden"  name="interface_open" value="<?php echo $search['interface_open']; ?>">
                                <a href="javascript:void(0);" onclick="_asr.selebtn_click(this,'');" class="<?php  echo $search['interface_open']!=""?"":"active"; ?>">全部</a>
                           <?php $keyvalue = table_Org_interface_open(); if(is_array($keyvalue)){ $i = 0; $__LIST__ = $keyvalue; ?>
                               <?php foreach($__LIST__ as $key=>$item): ++$i; ?>
                                 <a href="javascript:void(0);" onclick="_asr.selebtn_click(this,'<?php echo $item['id'];?>');" class="<?php  echo $search['interface_open']!=$item['id']?"":"active"; ?>"><?php echo $item['name']; ?></a>
                               <?php if($i==2) break; ?>
                               <?php endforeach; ?>
                           <?php } ?>
                             </div>
                  ...
                  <li>
                      <div class="unit-left"> 接口类型</div>
                      <div class="unit-mid">
                          <div class="dropdown" id="<?php echo ($funcid); ?>_interface_type">
                             <select class="pbsele dropdown0" name="interface_type">
                                <option value="" <?php if($search['interface_type'] == ''): ?> selected="selected" <?php endif;?> ></option>
                               <?php
 $keyvalue = table_Org_interface_type(); if(is_array($keyvalue)){ $i = 0; $__LIST__ = $keyvalue; ?>
                                      <?php foreach($__LIST__ as $key=>$item): ++$i; ?>
                                   <option value="<?php echo $item['id']; ?>" <?php if($item['id'] == $search['interface_type']): ?> selected="selected" <?php endif;?>><?php echo charlevel($item['level']).$item['name']; ?></option>
                                      <?php endforeach; ?>
                               <?php } ?>
                             </select>
                          </div>
          ...
          <?php if (isset($rights['search']) && $rights['search']): ?>
               <input type="button" value="搜索" class="btn btn-org  mrg_10 " onclick="return _asr.submit('<?php echo "$funcid"; ?>', '<?php echo "$funcid"; ?>-Search', '<?php echo U("OrgSummary/index?func=search&") ; ?>',''); " />
          <?php endif; ?>
          ...
          <?php if (isset($rights['export']) && $rights['export']): ?>
               <input type="button" value="导出" class="btn btn-blue mrg_10 " onclick="return _asr.showExport('<?php echo "$funcid"; ?>', '<?php echo "$funcid"; ?>-Search', '<?php echo U("OrgSummary/index?func=export&") ; ?>',<?php echo $p ?>); " />
          <?php endif; ?>

                    <em class="pdr_20"></em>
                    <a href="javascript:void(0);" class="table-set <?php echo count($colshow)>0?"vi-blue":"abe-gray3"; ?>"  onclick="return _asr.popupFun('<?php echo U("/Summary/OrgSummary/index?func=columnsetting&") ; ?>','<?php echo filterFuncId("/OrgSummary/column","");?>');  " ><em class="iconfont abe-ft14 mrg_5">&#xe60a;</em>设置</a>
                    </div>
                  </div>
      </form>
    </div>
  ...
  <div class="wrap-nmd-box">
    <div class="wrap-master ">
      ...
      <div class="list-scroll">
        <div class="table-box">
          <div class="table-in">
            <form id="<?php echo "$funcid"; ?>-Result"  action="<?php U('OrgSummary/op'); ?>" method="post">
          ...
          <!-- 序号        <col style="width: 40px ;">   -->
                           ...
                           <col style="width: 80px ; <?php if(isset($colshow["type"]) && $colshow["type"]=="0"): ?>display:none;<?php endif; ?> ">  <!-- 机构类型 -->
                           <col style="width: 80px ; <?php if(isset($colshow["code"]) && $colshow["code"]=="0"): ?>display:none;<?php endif; ?> ">  <!-- 机构代码 -->
                           <col style="width: 100px ; <?php if(isset($colshow["name"]) && $colshow["name"]=="0"): ?>display:none;<?php endif; ?> ">  <!-- 机构名称 -->
                           <col style="width: 80px ; <?php if(isset($colshow["phone"]) && $colshow["phone"]=="0"): ?>display:none;<?php endif; ?> ">  <!-- 联系电话 -->
                           <col style="width: 80px ; <?php if(isset($colshow["contacts"]) && $colshow["contacts"]=="0"): ?>display:none;<?php endif; ?> ">  <!-- 联系人员 -->
                           <col style="width: 100px ; <?php if(isset($colshow["address"]) && $colshow["address"]=="0"): ?>display:none;<?php endif; ?> ">  <!-- 联系地址 -->
                           <col style="width: 80px ; <?php if(isset($colshow["interface_open"]) && $colshow["interface_open"]=="0"): ?>display:none;<?php endif; ?> ">  <!-- 接口控制 -->
                           <col style="width: 80px ; <?php if(isset($colshow["interface_type"]) && $colshow["interface_type"]=="0"): ?>display:none;<?php endif; ?> ">  <!-- 接口类型 -->
          ...
          <!-- 序号       <th>序号</th>   -->
                          ...
                          <th <?php if(isset($colshow["type"]) && $colshow["type"]=="0"): ?> style="display:none" <?php endif; ?>>机构类型</th>
                          <th <?php if(isset($colshow["code"]) && $colshow["code"]=="0"): ?> style="display:none" <?php endif; ?> class="abe-txtl">机构代码</th>
                          <th <?php if(isset($colshow["name"]) && $colshow["name"]=="0"): ?> style="display:none" <?php endif; ?> class="abe-txtl">机构名称</th>
                          <th <?php if(isset($colshow["phone"]) && $colshow["phone"]=="0"): ?> style="display:none" <?php endif; ?> class="abe-txtl">联系电话</th>
                          <th <?php if(isset($colshow["contacts"]) && $colshow["contacts"]=="0"): ?> style="display:none" <?php endif; ?> class="abe-txtl">联系人员</th>
                          <th <?php if(isset($colshow["address"]) && $colshow["address"]=="0"): ?> style="display:none" <?php endif; ?> class="abe-txtl">联系地址</th>
                          <th <?php if(isset($colshow["interface_open"]) && $colshow["interface_open"]=="0"): ?> style="display:none" <?php endif; ?>>接口控制</th>
                          <th <?php if(isset($colshow["interface_type"]) && $colshow["interface_type"]=="0"): ?> style="display:none" <?php endif; ?>>接口类型</th>
          ...
          <?php if (isset($rights['master_view']) && $rights['master_view']): ?>
               <a href="javascript:void(0);"  class=" vi-blue vi-blue " onclick="return _asr.openLink('<?php echo U("/Home/Org/index?func=view&id=$master[id]") ; ?>', '<?php echo filterFuncId(U("/Home/Org/index?func=view&id=$master[id]"),"");?>' , '<?php echo tabTitle("库联联盟机构","$master[code]") ; ?>' ,0); "><i class="iconfont abe-ft18">&#xe62e;</i></a>
          <?php endif; ?>
          ...
          <?php if ($master['status']==0): ?>
               <a href="javascript:void(0);"  class=" vi-blue vi-blue " onclick="return _asr.popupFun('<?php echo U("/Home/Org/index?func=edit&id=$master[id]") ; ?>', '<?php echo filterFuncId("/Home/Org/index?func=edit&id=$master[id]","");?>'); "><i class="iconfont abe-ft15">&#xe63f;</i></a>
          <?php endif; ?>
          <?php endif; ?>
          ...
          <?php if ($master['status']==0): ?>
               <a href="javascript:void(0);"  class=" vi-blue vi-blue " onclick="return _asr.confirm('确认操作', '请确认是否删除库联联盟机构?', '<?php echo "库联联盟机构 : $master[code]"; ?>', '<?php echo U("/Home/Org/index?func=delete&type=1&id=$master[id]") ; ?>','',''); "><i class="iconfont vi-red">&#xe61d;</i></a>
          <?php endif; ?>
          <?php endif; ?></td>


                                  <td style=" <?php if(isset($colshow["status"]) && $colshow["status"]=="0"): ?>display:none<?php endif; ?> " ><?php echo get_table_Org_status("$master[status]","name","") ; ?></td>
                                  <td style=" <?php if(isset($colshow["type"]) && $colshow["type"]=="0"): ?>display:none<?php endif; ?> " ><?php echo get_table_Org_type("$master[type]","name","") ; ?></td>
                                  <td style=" <?php if(isset($colshow["code"]) && $colshow["code"]=="0"): ?>display:none<?php endif; ?> " class=" abe-txtl "><?php echo $master["code"] ; ?></td>
                                  ...
                                  <td style=" <?php if(isset($colshow["contacts"]) && $colshow["contacts"]=="0"): ?>display:none<?php endif; ?> " class=" abe-txtl "><?php echo $master["contacts"] ; ?></td>
                                  <td style=" <?php if(isset($colshow["address"]) && $colshow["address"]=="0"): ?>display:none<?php endif; ?> " class=" abe-txtl "><div class="newline newline-l"><?php echo OverView($master["address"],100,"...") ; ?></div></td>
                                  <td style=" <?php if(isset($colshow["interface_open"]) && $colshow["interface_open"]=="0"): ?>display:none<?php endif; ?> " ><?php echo get_table_Org_interface_open("$master[interface_open]","name","") ; ?></td>
                                  <td style=" <?php if(isset($colshow["interface_type"]) && $colshow["interface_type"]=="0"): ?>display:none<?php endif; ?> " ><?php echo get_table_Org_interface_type("$master[interface_type]","name","") ; ?></td>
          ...
          <?php if (!$master['status']): ?>
               <input type="button" value="转有效" class="btn btn-sm btn-blue mlg_10 " onclick="return _asr.popupFun('<?php echo U("/Home/Org/index?func=status_on&id=$master[id]") ; ?>', '<?php echo filterFuncId("/Home/Org/index?func=status_on&id=$master[id]","");?>'); " />
          <?php endif; ?>
          <?php endif; ?>
          ...
          <?php if ($master['status']=='1'): ?>
               <input type="button" value="转失效" class="btn btn-sm btn-org mlg_10 " onclick="return _asr.popupFun('<?php echo U("/Home/Org/index?func=status_off&id=$master[id]") ; ?>', '<?php echo filterFuncId("/Home/Org/index?func=status_off&id=$master[id]","");?>'); " />
          <?php endif; ?>
          <?php endif; ?></td>
    ...
    <script>
        ...
        function <?php echo $funcid; ?>_clearsearch(_frm){
            ...
            _asr.setvaluebyname(_frm,"contacts","");
            _asr.setvaluebyname(_frm,"address","");
            _asr.setvaluebyname(_frm,"interface_open","");
            _asr.setvaluebyname(_frm,"interface_type","");
    ...
    <?php echo W('Summary/javascript',array('OrgSummary'));?>
