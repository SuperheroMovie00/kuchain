...
<div toplayer="1" class="wrap-box wrap-nmd wrap-style00 " id="<?php echo $funcid;?>" summaryid="StorecardMovementSummary" baseurl="<?php echo U('StorecardMovementSummary/index'); ?>">
  <div class="wrap-box-info ">

    <div class="wrap-title abe-ofl">
      <div class="tit abe-fl" style="width: 450px;">存储卡台账列表</div>
      <div class="abe-fl">
        <div class="textbox" >
          <div  id="<?php echo "$funcid"; ?>-keyword-info" class="abe-fl"<?php if($search["_showsearch"]=="show"):?>style="display:none;"<?php endif; ?>>
             ...
             <input type="button" value="搜索" class="btn btn-org  mrg_10 " id="<?php echo $funcid;?>-keyword-search"  default-status="1"  onclick="<?php echo ($funcid); ?>_keyword_set(); return _asr.submit('<?php echo "$funcid"; ?>', '<?php echo "$funcid"; ?>-Search', '<?php echo U("StorecardMovementSummary/index?func=search&") ; ?>',''); " />
             <input id="<?php echo $funcid;?>-search-buttc" type="button" value="导出" class="btn btn-blue mrg_10 " default-status="1" onclick="return _asr.showExport('<?php echo "$funcid"; ?>', '<?php echo "$funcid"; ?>-Search', '<?php echo U("StorecardMovementSummary/index?func=export&") ; ?>',<?php echo $p ?>); " />
          </div>
    ...
    <div class="screening"  >
      <form action="<?php echo U('StorecardMovementSummary/index?func=search'); ?>" id="<?php echo "$funcid"; ?>-Search" method="get">
 ...
 $keyvalue = table_Org(); if(is_array($keyvalue)){ $i = 0; $__LIST__ = $keyvalue; ?>
                  ...
                  <li>
                      <div class="unit-left"> 单据号码</div>
                      <div class="unit-mid">
                          <div class="textbox">
                              <input type="text" class="pbtxt txt0" name="order_no"  value="<?php echo $search['order_no']; ?>"   placeholder=" 输入%可进行匹配模糊搜索 ">
                          </div>
                          <div class="prompt" style="display:none">
                              <div class="error"><i class="iconfont">&#xe616;</i></div>
                          </div>
                  ...
                  <li>
                      <div class="unit-left"> 单据类型</div>
                      <div class="unit-mid">
                          <div class="textbox">
                              <input type="text" class="pbtxt txt0" name="order_type"  value="<?php echo $search['order_type']; ?>"   placeholder=" 输入%可进行匹配模糊搜索 ">
                          </div>
                          <div class="prompt" style="display:none">
                              <div class="error"><i class="iconfont">&#xe616;</i></div>
                          </div>
                  ...
                  <li>
                      <div class="unit-left"> 单据日期</div>
                      <div class="unit-mid">
                          <div class="calendar">
                              <input type="text" class="pbtxt calendar1" name="order_date"  value= "<?php echo system_format("D", $search["order_date"],0); ?>"  >
                              <em class="space-line">-</em>
                              <input type="text" class="pbtxt calendar1" name="order_date2" value="<?php echo $search['order_date2']; ?>"  >
                          </div>
                          <div class="prompt" style="display:none">
                              <div class="error"><i class="iconfont">&#xe616;</i></div>
                          </div>
                ...
                <ul class="form form-mod-new split" style="<?php if($search["_searchexpand"]!="1"): echo "display:none"; endif; ?>">
                  ...
                  <li>
                      <div class="unit-left"> 接收方</div>
                      <div class="unit-mid">
                          <div class="textbox">
                              <input type="text" class="pbtxt txt0" name="to_customer_id"  value="<?php echo $search['to_customer_id']; ?>"  >
                          </div>
                          <div class="prompt" style="display:none">
                              <div class="error"><i class="iconfont">&#xe616;</i></div>
                          </div>
                  ...
                  <li>
                      ...
                      <div class="unit-mid">
                          <div class="textbox">
                              <input type="text" class="pbtxt txt0" name="to_customer_name"  value="<?php echo $search['to_customer_name']; ?>"   placeholder=" 直接进行模糊搜索 ">
                          </div>
                          <div class="prompt" style="display:none">
                              <div class="error"><i class="iconfont">&#xe616;</i></div>
                          </div>
                  ...
                  <li>
                      <div class="unit-left"> 库存重量</div>
                      <div class="unit-mid">
                          <div class="textbox">
                              <input type="text" class="pbtxt txt1" name="store_weight"  value="<?php echo $search['store_weight']; ?>"  >
                              <em class="space-line">-</em>
                              <input type="text" class="pbtxt txt1" name="store_weight2" value="<?php echo $search['store_weight2']; ?>"  >
                          </div>
                          <div class="prompt" style="display:none">
                              <div class="error"><i class="iconfont">&#xe616;</i></div>
                          </div>
                  ...
                  <li>
                      <div class="unit-left"> 库存数量/件</div>
                      <div class="unit-mid">
                          <div class="textbox">
                              <input type="text" class="pbtxt txt1" name="store_qty"  value="<?php echo $search['store_qty']; ?>"  >
                              <em class="space-line">-</em>
                              <input type="text" class="pbtxt txt1" name="store_qty2" value="<?php echo $search['store_qty2']; ?>"  >
                          </div>
                          <div class="prompt" style="display:none">
                              <div class="error"><i class="iconfont">&#xe616;</i></div>
                          </div>
                  ...
                  <li>
                      <div class="unit-left"> 库存散件</div>
                      <div class="unit-mid">
                          <div class="textbox">
                              <input type="text" class="pbtxt txt1" name="store_bulkcargo"  value="<?php echo $search['store_bulkcargo']; ?>"  >
                              <em class="space-line">-</em>
                              <input type="text" class="pbtxt txt1" name="store_bulkcargo2" value="<?php echo $search['store_bulkcargo2']; ?>"  >
                          </div>
                          <div class="prompt" style="display:none">
                              <div class="error"><i class="iconfont">&#xe616;</i></div>
                          </div>
                  ...
                  <li>
                      <div class="unit-left"> 合计锁重量</div>
                      <div class="unit-mid">
                          <div class="textbox">
                              <input type="text" class="pbtxt txt1" name="storelock_weight"  value="<?php echo $search['storelock_weight']; ?>"  >
                              <em class="space-line">-</em>
                              <input type="text" class="pbtxt txt1" name="storelock_weight2" value="<?php echo $search['storelock_weight2']; ?>"  >
                          </div>
                          <div class="prompt" style="display:none">
                              <div class="error"><i class="iconfont">&#xe616;</i></div>
                          </div>
                  ...
                  <li>
                      <div class="unit-left"> 合计锁数量/件</div>
                      <div class="unit-mid">
                          <div class="textbox">
                              <input type="text" class="pbtxt txt1" name="storelock_qty"  value="<?php echo $search['storelock_qty']; ?>"  >
                              <em class="space-line">-</em>
                              <input type="text" class="pbtxt txt1" name="storelock_qty2" value="<?php echo $search['storelock_qty2']; ?>"  >
                          </div>
                          <div class="prompt" style="display:none">
                              <div class="error"><i class="iconfont">&#xe616;</i></div>
                          </div>
                  ...
                  <li>
                      <div class="unit-left"> 合计锁散件</div>
                      <div class="unit-mid">
                          <div class="textbox">
                              <input type="text" class="pbtxt txt1" name="storelock_bulkcargo"  value="<?php echo $search['storelock_bulkcargo']; ?>"  >
                              <em class="space-line">-</em>
                              <input type="text" class="pbtxt txt1" name="storelock_bulkcargo2" value="<?php echo $search['storelock_bulkcargo2']; ?>"  >
                          </div>
                          <div class="prompt" style="display:none">
                              <div class="error"><i class="iconfont">&#xe616;</i></div>
                          </div>
          ...
          <?php if (isset($rights['search']) && $rights['search']): ?>
               <input type="button" value="搜索" class="btn btn-org  mrg_10 " onclick="return _asr.submit('<?php echo "$funcid"; ?>', '<?php echo "$funcid"; ?>-Search', '<?php echo U("StorecardMovementSummary/index?func=search&") ; ?>',''); " />
          <?php endif; ?>
          ...
          <?php if (isset($rights['export']) && $rights['export']): ?>
               <input type="button" value="导出" class="btn btn-blue mrg_10 " onclick="return _asr.showExport('<?php echo "$funcid"; ?>', '<?php echo "$funcid"; ?>-Search', '<?php echo U("StorecardMovementSummary/index?func=export&") ; ?>',<?php echo $p ?>); " />
          <?php endif; ?>

                    <em class="pdr_20"></em>
                    <button class="btn btn-xs hid-btn" type="button" onclick="return _asr.showSearch(this);">展开选项<i class="iconfont">&#xe612;</i></button>
                    <a href="javascript:void(0);" class="table-set <?php echo count($colshow)>0?"vi-blue":"abe-gray3"; ?>"  onclick="return _asr.popupFun('<?php echo U("/Summary/StorecardMovementSummary/index?func=columnsetting&") ; ?>','<?php echo filterFuncId("/StorecardMovementSummary/column","");?>');  " ><em class="iconfont abe-ft14 mrg_5">&#xe60a;</em>设置</a>
                    </div>
                  </div>
      </form>
    </div>
  ...
  <div class="wrap-nmd-box">
    <div class="wrap-master ">
      ...
      <div class="list-scroll">
        <div class="table-box">
          <div class="table-in">
            <form id="<?php echo "$funcid"; ?>-Result"  action="<?php U('StorecardMovementSummary/op'); ?>" method="post">
          ...
          <!-- 序号        <col style="width: 40px ;">   -->
                           ...
                           <col style="width: 80px ; <?php if(isset($colshow["order_no"]) && $colshow["order_no"]=="0"): ?>display:none;<?php endif; ?> ">  <!-- 单据号码 -->
                           <col style="width: 80px ; <?php if(isset($colshow["order_type"]) && $colshow["order_type"]=="0"): ?>display:none;<?php endif; ?> ">  <!-- 单据类型 -->
                           <col style="width: 80px ; <?php if(isset($colshow["order_date"]) && $colshow["order_date"]=="0"): ?>display:none;<?php endif; ?> ">  <!-- 单据日期 -->
                           ...
                           <col style="width: 80px ; <?php if(isset($colshow["style_code"]) && $colshow["style_code"]=="0"): ?>display:none;<?php endif; ?> ">  <!-- 平台编码 -->
                           <col style="width: 80px ; <?php if(isset($colshow["batchno"]) && $colshow["batchno"]=="0"): ?>display:none;<?php endif; ?> ">  <!-- 货品批号 -->
                           <col style="width: 80px ; <?php if(isset($colshow["to_customer_id"]) && $colshow["to_customer_id"]=="0"): ?>display:none;<?php endif; ?> ">  <!-- 接收方 -->
                           <col style="width: 100px ; <?php if(isset($colshow["to_customer_name"]) && $colshow["to_customer_name"]=="0"): ?>display:none;<?php endif; ?> ">  <!-- 接收方 -->
                           ...
                           <col style="width: 80px ; <?php if(isset($colshow["store_weight"]) && $colshow["store_weight"]=="0"): ?>display:none;<?php endif; ?> ">  <!-- 库存重量 -->
                           <col style="width: 80px ; <?php if(isset($colshow["store_qty"]) && $colshow["store_qty"]=="0"): ?>display:none;<?php endif; ?> ">  <!-- 库存数量 -->
                           <col style="width: 80px ; <?php if(isset($colshow["store_bulkcargo"]) && $colshow["store_bulkcargo"]=="0"): ?>display:none;<?php endif; ?> ">  <!-- 库存散件 -->
                           <col style="width: 80px ; <?php if(isset($colshow["storelock_weight"]) && $colshow["storelock_weight"]=="0"): ?>display:none;<?php endif; ?> ">  <!-- 合计锁重量 -->
                           <col style="width: 80px ; <?php if(isset($colshow["storelock_qty"]) && $colshow["storelock_qty"]=="0"): ?>display:none;<?php endif; ?> ">  <!-- 合计锁数量 -->
                           <col style="width: 80px ; <?php if(isset($colshow["storelock_bulkcargo"]) && $colshow["storelock_bulkcargo"]=="0"): ?>display:none;<?php endif; ?> ">  <!-- 合计锁散件 -->
          ...
          <!-- 序号       <th>序号</th>   -->
                          ...
                          <th <?php if(isset($colshow["order_no"]) && $colshow["order_no"]=="0"): ?> style="display:none" <?php endif; ?> class="abe-txtl">单据号码</th>
                          <th <?php if(isset($colshow["order_type"]) && $colshow["order_type"]=="0"): ?> style="display:none" <?php endif; ?>>单据类型</th>
                          <th <?php if(isset($colshow["order_date"]) && $colshow["order_date"]=="0"): ?> style="display:none" <?php endif; ?>>单据日期</th>
                          ...
                          <th <?php if(isset($colshow["style_code"]) && $colshow["style_code"]=="0"): ?> style="display:none" <?php endif; ?> class="abe-txtl">平台编码</th>
                          <th <?php if(isset($colshow["batchno"]) && $colshow["batchno"]=="0"): ?> style="display:none" <?php endif; ?> class="abe-txtl">货品批号</th>
                          <th <?php if(isset($colshow["to_customer_id"]) && $colshow["to_customer_id"]=="0"): ?> style="display:none" <?php endif; ?>>接收方</th>
                          <th <?php if(isset($colshow["to_customer_name"]) && $colshow["to_customer_name"]=="0"): ?> style="display:none" <?php endif; ?> class="abe-txtl">接收方</th>
                          ...
                          <th <?php if(isset($colshow["store_weight"]) && $colshow["store_weight"]=="0"): ?> style="display:none" <?php endif; ?> class="abe-txtr">库存重量</th>
                          <th <?php if(isset($colshow["store_qty"]) && $colshow["store_qty"]=="0"): ?> style="display:none" <?php endif; ?> class="abe-txtr">库存数量</th>
                          <th <?php if(isset($colshow["store_bulkcargo"]) && $colshow["store_bulkcargo"]=="0"): ?> style="display:none" <?php endif; ?> class="abe-txtr">库存散件</th>
                          <th <?php if(isset($colshow["storelock_weight"]) && $colshow["storelock_weight"]=="0"): ?> style="display:none" <?php endif; ?> class="abe-txtr">合计锁重量</th>
                          <th <?php if(isset($colshow["storelock_qty"]) && $colshow["storelock_qty"]=="0"): ?> style="display:none" <?php endif; ?> class="abe-txtr">合计锁数量</th>
                          <th <?php if(isset($colshow["storelock_bulkcargo"]) && $colshow["storelock_bulkcargo"]=="0"): ?> style="display:none" <?php endif; ?> class="abe-txtr">合计锁散件</th>
          ...
          <?php if (isset($rights['master_view']) && $rights['master_view']): ?>
               <a href="javascript:void(0);"  class=" vi-blue vi-blue " onclick="return _asr.openLink('<?php echo U("/Home/StorecardMovement/index?func=view&id=$master[id]") ; ?>', '<?php echo filterFuncId(U("/Home/StorecardMovement/index?func=view&id=$master[id]"),"");?>' , '<?php echo tabTitle("存储卡台账","$master[order_no]","RIGHT","8") ; ?>' ,0); "><i class="iconfont abe-ft18">&#xe62e;</i></a>
          <?php endif; ?></td>
                                  ...
                                  <td style=" <?php if(isset($colshow["order_no"]) && $colshow["order_no"]=="0"): ?>display:none<?php endif; ?> " class=" abe-txtl "><?php echo $master["order_no"] ; ?></td>
                                  <td style=" <?php if(isset($colshow["order_type"]) && $colshow["order_type"]=="0"): ?>display:none<?php endif; ?> " ><?php echo $master["order_type"] ; ?></td>
                                  <td style=" <?php if(isset($colshow["order_date"]) && $colshow["order_date"]=="0"): ?>display:none<?php endif; ?> " ><?php echo system_format("D", $master["order_date"],1) ; ?></td>
                                  ...
                                  <td style=" <?php if(isset($colshow["to_customer_id"]) && $colshow["to_customer_id"]=="0"): ?>display:none<?php endif; ?> " ><?php echo $master["to_customer_id"] ; ?></td>
                                  <td style=" <?php if(isset($colshow["to_customer_name"]) && $colshow["to_customer_name"]=="0"): ?>display:none<?php endif; ?> " class=" abe-txtl "><?php echo $master["to_customer_name"] ; ?></td>
                                  ...
                                  <td style=" <?php if(isset($colshow["store_weight"]) && $colshow["store_weight"]=="0"): ?>display:none<?php endif; ?> " class=" abe-txtr <?php if ($master['store_weight']<0): ?> abe-red <?php endif; ?> "><?php echo system_format("F33", $master["store_weight"],1) ; ?></td>
                                  <td style=" <?php if(isset($colshow["store_qty"]) && $colshow["store_qty"]=="0"): ?>display:none<?php endif; ?> " class=" abe-txtr <?php if ($master['store_qty']<0): ?> abe-red <?php endif; ?> "><?php echo system_format("N3", $master["store_qty"],1) ; ?></td>
                                  <td style=" <?php if(isset($colshow["store_bulkcargo"]) && $colshow["store_bulkcargo"]=="0"): ?>display:none<?php endif; ?> " class=" abe-txtr <?php if ($master['store_bulkcargo']<0): ?> abe-red <?php endif; ?> "><?php echo system_format("N3", $master["store_bulkcargo"],1) ; ?></td>
                                  <td style=" <?php if(isset($colshow["storelock_weight"]) && $colshow["storelock_weight"]=="0"): ?>display:none<?php endif; ?> " class=" abe-txtr <?php if ($master['storelock_weight']<0): ?> abe-red <?php endif; ?> "><?php echo system_format("F33", $master["storelock_weight"],1) ; ?></td>
                                  <td style=" <?php if(isset($colshow["storelock_qty"]) && $colshow["storelock_qty"]=="0"): ?>display:none<?php endif; ?> " class=" abe-txtr <?php if ($master['storelock_qty']<0): ?> abe-red <?php endif; ?> "><?php echo system_format("N3", $master["storelock_qty"],1) ; ?></td>
                                  <td style=" <?php if(isset($colshow["storelock_bulkcargo"]) && $colshow["storelock_bulkcargo"]=="0"): ?>display:none<?php endif; ?> " class=" abe-txtr <?php if ($master['storelock_bulkcargo']<0): ?> abe-red <?php endif; ?> "><?php echo system_format("N3", $master["storelock_bulkcargo"],1) ; ?></td>
    ...
    <script>
        ...
        function <?php echo $funcid; ?>_clearsearch(_frm){
            ...
            _asr.setvaluebyname(_frm,"order_no","");
            _asr.setvaluebyname(_frm,"order_type","");
            _asr.setvaluebyname(_frm,"order_date","");
            _asr.setvaluebyname(_frm,"order_date2","");
            ...
            _asr.setvaluebyname(_frm,"to_customer_id","");
            _asr.setvaluebyname(_frm,"to_customer_name","");
            ...
            _asr.setvaluebyname(_frm,"store_weight","");
            _asr.setvaluebyname(_frm,"store_weight2","");
            _asr.setvaluebyname(_frm,"store_qty","");
            _asr.setvaluebyname(_frm,"store_qty2","");
            _asr.setvaluebyname(_frm,"store_bulkcargo","");
            _asr.setvaluebyname(_frm,"store_bulkcargo2","");
            _asr.setvaluebyname(_frm,"storelock_weight","");
            _asr.setvaluebyname(_frm,"storelock_weight2","");
            _asr.setvaluebyname(_frm,"storelock_qty","");
            _asr.setvaluebyname(_frm,"storelock_qty2","");
            _asr.setvaluebyname(_frm,"storelock_bulkcargo","");
            _asr.setvaluebyname(_frm,"storelock_bulkcargo2","");
    ...
    <?php echo W('Summary/javascript',array('StorecardMovementSummary'));?>
