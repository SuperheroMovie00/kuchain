...
<div toplayer="1" class="wrap-box wrap-nmd wrap-style00 " id="<?php echo $funcid;?>" summaryid="StorecardSummary" baseurl="<?php echo U('StorecardSummary/index'); ?>">
  <div class="wrap-box-info ">

    <div class="wrap-title abe-ofl">
      <div class="tit abe-fl" style="width: 450px;">存储卡列表</div>
      <div class="abe-fl">
        <div class="textbox" >
          <div  id="<?php echo "$funcid"; ?>-keyword-info" class="abe-fl"<?php if($search["_showsearch"]=="show"):?>style="display:none;"<?php endif; ?>>
             ...
             <input type="button" value="搜索" class="btn btn-org  mrg_10 " id="<?php echo $funcid;?>-keyword-search"  default-status="1"  onclick="<?php echo ($funcid); ?>_keyword_set(); return _asr.submit('<?php echo "$funcid"; ?>', '<?php echo "$funcid"; ?>-Search', '<?php echo U("StorecardSummary/index?func=search&") ; ?>',''); " />
             <input id="<?php echo $funcid;?>-search-buttc" type="button" value="导出" class="btn btn-blue mrg_10 " default-status="1" onclick="return _asr.showExport('<?php echo "$funcid"; ?>', '<?php echo "$funcid"; ?>-Search', '<?php echo U("StorecardSummary/index?func=export&") ; ?>',<?php echo $p ?>); " />
          </div>
      ...
      <div class="abe-fr">
        <a href="javascript:void(0);" class="mrg_15 vi-blue search-hide" <?php if($search["_showsearch"]=="hide"):?>style="display:none;"<?php endif; ?>><i class="iconfont">&#xe673;</i>收起搜索</a>
          ...
          <?php if (isset($rights['import']) && $rights['import']): ?>
               <input type="button" value="数据导入" class="btn btn-blue mrg_10 " onclick="return _asr.popupFun('<?php echo U("/Home/Storecard/index?func=import&") ; ?>', '<?php echo filterFuncId("/Home/Storecard/index?func=import&","");?>'); " />
          <?php endif; ?>
    ...
    <div class="screening"  >
      <form action="<?php echo U('StorecardSummary/index?func=search'); ?>" id="<?php echo "$funcid"; ?>-Search" method="get">
                  ...
                  <li>
                      ...
                      <div class="unit-mid">
                          <div class="dropdown" id="<?php echo ($funcid); ?>_status">
                           ...
                           <?php $keyvalue = table_Storecard_status(); if(is_array($keyvalue)){ $i = 0; $__LIST__ = $keyvalue; ?>
 ...
 $keyvalue = table_Org(); if(is_array($keyvalue)){ $i = 0; $__LIST__ = $keyvalue; ?>
                  ...
                  <li>
                      <div class="unit-left"> 初始重量</div>
                      <div class="unit-mid">
                          <div class="textbox">
                              <input type="text" class="pbtxt txt1" name="orig_weight"  value="<?php echo $search['orig_weight']; ?>"  >
                              <em class="space-line">-</em>
                              <input type="text" class="pbtxt txt1" name="orig_weight2" value="<?php echo $search['orig_weight2']; ?>"  >
                          </div>
                          <div class="prompt" style="display:none">
                              <div class="error"><i class="iconfont">&#xe616;</i></div>
                          </div>
 ...
 $keyvalue = subcode('UOM_BULKCARGO'); if(is_array($keyvalue)){ $i = 0; $__LIST__ = $keyvalue; ?>
                  ...
                  <li>
                      <div class="unit-left"> 合同</div>
                      <div class="unit-mid">
                          <div class="textbox">
                              <input type="text" class="pbtxt txt0" name="contact_id"  value="<?php echo $search['contact_id']; ?>"  >
                          </div>
                          <div class="prompt" style="display:none">
                              <div class="error"><i class="iconfont">&#xe616;</i></div>
                          </div>
                  ...
                  <li>
                      <div class="unit-left"> 仓储合同</div>
                      <div class="unit-mid">
                          <div class="textbox">
                              <input type="text" class="pbtxt txt0" name="contact_no"  value="<?php echo $search['contact_no']; ?>"   placeholder=" 输入%可进行匹配模糊搜索 ">
                          </div>
                          <div class="prompt" style="display:none">
                              <div class="error"><i class="iconfont">&#xe616;</i></div>
                          </div>
                  ...
                  <li>
                      ...
                      <div class="unit-mid">
                          <div class="calendar">
                              <input type="text" class="pbtxt calendar1" name="stockin_date"  value= "<?php echo system_format("D", $search["stockin_date"],0); ?>"  >
                              <em class="space-line">-</em>
                              <input type="text" class="pbtxt calendar1" name="stockin_date2" value="<?php echo $search['stockin_date2']; ?>"  >
                          </div>
                          <div class="prompt" style="display:none">
                              <div class="error"><i class="iconfont">&#xe616;</i></div>
                          </div>
                  ...
                  <li>
                      <div class="unit-left"> 仓费支付方</div>
                      <div class="unit-mid">
                          <div class="textbox">
                              <input type="text" class="pbtxt txt0" name="fee_customer_id"  value="<?php echo $search['fee_customer_id']; ?>"  >
                          </div>
                          <div class="prompt" style="display:none">
                              <div class="error"><i class="iconfont">&#xe616;</i></div>
                          </div>
                  ...
                  <li>
                      ...
                      <div class="unit-mid">
                          <div class="textbox">
                              <input type="text" class="pbtxt txt0" name="fee_customer_name"  value="<?php echo $search['fee_customer_name']; ?>"   placeholder=" 直接进行模糊搜索 ">
                          </div>
                          <div class="prompt" style="display:none">
                              <div class="error"><i class="iconfont">&#xe616;</i></div>
                          </div>
                  ...
                  <li>
                      <div class="unit-left"> 仓费起始日</div>
                      <div class="unit-mid">
                          <div class="calendar">
                              <input type="text" class="pbtxt calendar1" name="fee_start"  value= "<?php echo system_format("DT", $search["fee_start"],0); ?>"  >
                              <em class="space-line">-</em>
                              <input type="text" class="pbtxt calendar1" name="fee_start2" value="<?php echo $search['fee_start2']; ?>"  >
                          </div>
                          <div class="prompt" style="display:none">
                              <div class="error"><i class="iconfont">&#xe616;</i></div>
                          </div>
          ...
          <?php if (isset($rights['search']) && $rights['search']): ?>
               <input type="button" value="搜索" class="btn btn-org  mrg_10 " onclick="return _asr.submit('<?php echo "$funcid"; ?>', '<?php echo "$funcid"; ?>-Search', '<?php echo U("StorecardSummary/index?func=search&") ; ?>',''); " />
          <?php endif; ?>
          ...
          <?php if (isset($rights['export']) && $rights['export']): ?>
               <input type="button" value="导出" class="btn btn-blue mrg_10 " onclick="return _asr.showExport('<?php echo "$funcid"; ?>', '<?php echo "$funcid"; ?>-Search', '<?php echo U("StorecardSummary/index?func=export&") ; ?>',<?php echo $p ?>); " />
          <?php endif; ?>

                    <em class="pdr_20"></em>
                    <button class="btn btn-xs hid-btn" type="button" onclick="return _asr.showSearch(this);">展开选项<i class="iconfont">&#xe612;</i></button>
                    <a href="javascript:void(0);" class="table-set <?php echo count($colshow)>0?"vi-blue":"abe-gray3"; ?>"  onclick="return _asr.popupFun('<?php echo U("/Summary/StorecardSummary/index?func=columnsetting&") ; ?>','<?php echo filterFuncId("/StorecardSummary/column","");?>');  " ><em class="iconfont abe-ft14 mrg_5">&#xe60a;</em>设置</a>
                    </div>
                  </div>
      </form>
    </div>
  ...
  <div class="wrap-nmd-box">
    <div class="wrap-master ">
      ...
      <div class="list-scroll">
        <div class="table-box">
          <div class="table-in">
            <form id="<?php echo "$funcid"; ?>-Result"  action="<?php U('StorecardSummary/op'); ?>" method="post">
          ...
          <!-- 序号        <col style="width: 40px ;">   -->
                           ...
                           <col style="width: 80px ; <?php if(isset($colshow["orig_weight"]) && $colshow["orig_weight"]=="0"): ?>display:none;<?php endif; ?> ">  <!-- 初始重量 -->
                           ...
                           <col style="width: 80px ; <?php if(isset($colshow["contact_id"]) && $colshow["contact_id"]=="0"): ?>display:none;<?php endif; ?> ">  <!-- 合同 -->
                           <col style="width: 80px ; <?php if(isset($colshow["contact_no"]) && $colshow["contact_no"]=="0"): ?>display:none;<?php endif; ?> ">  <!-- 仓储合同 -->
                           <col style="width: 80px ; <?php if(isset($colshow["stockin_date"]) && $colshow["stockin_date"]=="0"): ?>display:none;<?php endif; ?> ">  <!-- 入库日期 -->
                           <col style="width: 80px ; <?php if(isset($colshow["fee_customer_id"]) && $colshow["fee_customer_id"]=="0"): ?>display:none;<?php endif; ?> ">  <!-- 仓费支付方 -->
                           <col style="width: 100px ; <?php if(isset($colshow["fee_customer_name"]) && $colshow["fee_customer_name"]=="0"): ?>display:none;<?php endif; ?> ">  <!-- 仓费支付方 -->
                           <col style="width: 150px ; <?php if(isset($colshow["fee_start"]) && $colshow["fee_start"]=="0"): ?>display:none;<?php endif; ?> ">  <!-- 仓费起始日 -->
          ...
          <!-- 序号       <th>序号</th>   -->
                          ...
                          <th <?php if(isset($colshow["orig_weight"]) && $colshow["orig_weight"]=="0"): ?> style="display:none" <?php endif; ?> class="abe-txtr">初始重量</th>
                          ...
                          <th <?php if(isset($colshow["contact_id"]) && $colshow["contact_id"]=="0"): ?> style="display:none" <?php endif; ?>>合同</th>
                          <th <?php if(isset($colshow["contact_no"]) && $colshow["contact_no"]=="0"): ?> style="display:none" <?php endif; ?>>仓储合同</th>
                          <th <?php if(isset($colshow["stockin_date"]) && $colshow["stockin_date"]=="0"): ?> style="display:none" <?php endif; ?>>入库日期</th>
                          <th <?php if(isset($colshow["fee_customer_id"]) && $colshow["fee_customer_id"]=="0"): ?> style="display:none" <?php endif; ?>>仓费支付方</th>
                          <th <?php if(isset($colshow["fee_customer_name"]) && $colshow["fee_customer_name"]=="0"): ?> style="display:none" <?php endif; ?> class="abe-txtl">仓费支付方</th>
                          <th <?php if(isset($colshow["fee_start"]) && $colshow["fee_start"]=="0"): ?> style="display:none" <?php endif; ?>>仓费起始日</th>
          ...
          <?php if (isset($rights['master_view']) && $rights['master_view']): ?>
               <a href="javascript:void(0);"  class=" vi-blue vi-blue " onclick="return _asr.openLink('<?php echo U("/Home/Storecard/index?func=view&id=$master[id]") ; ?>', '<?php echo filterFuncId(U("/Home/Storecard/index?func=view&id=$master[id]"),"");?>' , '<?php echo tabTitle("存储卡","$master[storecard_no]") ; ?>' ,0); "><i class="iconfont abe-ft18">&#xe62e;</i></a>
          <?php endif; ?></td>


                                  <td style=" <?php if(isset($colshow["status"]) && $colshow["status"]=="0"): ?>display:none<?php endif; ?> " ><?php echo get_table_Storecard_status("$master[status]","name","") ; ?></td>
                                  ...
                                  <td style=" <?php if(isset($colshow["storecard_no"]) && $colshow["storecard_no"]=="0"): ?>display:none<?php endif; ?> " class=" abe-txtl "><a href="javascript:void(0);" class="vi-blue"  onclick="return _asr.openLink('<?php echo U("/Home/Storecard/index?func=view&id=$master[id]"); ?>','<?php echo filterFuncId( U("/Home/Storecard/index?func=view&id=$master[id]") ,"");?>', '存储卡详情' ,0); " ><?php echo $master["storecard_no"] ; ?></a></td>
                                  ...
                                  <td style=" <?php if(isset($colshow["orig_weight"]) && $colshow["orig_weight"]=="0"): ?>display:none<?php endif; ?> " class=" abe-txtr <?php if ($master['orig_weight']<0): ?> abe-red <?php endif; ?> "><?php echo system_format("F33", $master["orig_weight"],1) ; ?></td>
                                  ...
                                  <td style=" <?php if(isset($colshow["contact_id"]) && $colshow["contact_id"]=="0"): ?>display:none<?php endif; ?> " ><?php echo $master["contact_id"] ; ?></td>
                                  <td style=" <?php if(isset($colshow["contact_no"]) && $colshow["contact_no"]=="0"): ?>display:none<?php endif; ?> " ><?php echo $master["contact_no"] ; ?></td>
                                  <td style=" <?php if(isset($colshow["stockin_date"]) && $colshow["stockin_date"]=="0"): ?>display:none<?php endif; ?> " ><?php echo system_format("D", $master["stockin_date"],1) ; ?></td>
                                  <td style=" <?php if(isset($colshow["fee_customer_id"]) && $colshow["fee_customer_id"]=="0"): ?>display:none<?php endif; ?> " ><?php echo $master["fee_customer_id"] ; ?></td>
                                  <td style=" <?php if(isset($colshow["fee_customer_name"]) && $colshow["fee_customer_name"]=="0"): ?>display:none<?php endif; ?> " class=" abe-txtl "><?php echo $master["fee_customer_name"] ; ?></td>
                                  <td style=" <?php if(isset($colshow["fee_start"]) && $colshow["fee_start"]=="0"): ?>display:none<?php endif; ?> " ><?php echo system_format("DT", $master["fee_start"],1) ; ?></td>
          ...
          <?php if (!$master['status']): ?>
               <input type="button" value="转有效" class="btn btn-sm btn-blue mlg_10 " onclick="return _asr.popupFun('<?php echo U("/Home/Storecard/index?func=status_on&id=$master[id]") ; ?>', '<?php echo filterFuncId("/Home/Storecard/index?func=status_on&id=$master[id]","");?>'); " />
          <?php endif; ?>
          <?php endif; ?>
          ...
          <?php if ($master['status']=='1'): ?>
               <input type="button" value="转无效" class="btn btn-sm btn-org mlg_10 " onclick="return _asr.popupFun('<?php echo U("/Home/Storecard/index?func=status_off&id=$master[id]") ; ?>', '<?php echo filterFuncId("/Home/Storecard/index?func=status_off&id=$master[id]","");?>'); " />
          <?php endif; ?>
          <?php endif; ?></td>
    ...
    <script>
        ...
        function <?php echo $funcid; ?>_clearsearch(_frm){
            ...
            _asr.setvaluebyname(_frm,"orig_weight","");
            _asr.setvaluebyname(_frm,"orig_weight2","");
            ...
            _asr.setvaluebyname(_frm,"contact_id","");
            _asr.setvaluebyname(_frm,"contact_no","");
            _asr.setvaluebyname(_frm,"stockin_date","");
            _asr.setvaluebyname(_frm,"stockin_date2","");
            _asr.setvaluebyname(_frm,"fee_customer_id","");
            _asr.setvaluebyname(_frm,"fee_customer_name","");
            _asr.setvaluebyname(_frm,"fee_start","");
            _asr.setvaluebyname(_frm,"fee_start2","");
    ...
    <?php echo W('Summary/javascript',array('StorecardSummary'));?>
