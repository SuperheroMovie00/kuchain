...
<div toplayer="1" class="wrap-box wrap-nmd wrap-style00 " id="<?php echo $funcid;?>" summaryid="UserSummary" baseurl="<?php echo U('UserSummary/index'); ?>">
  <div class="wrap-box-info ">

    <div class="wrap-title abe-ofl">
      <div class="tit abe-fl" style="width: 450px;">用户信息列表</div>
      <div class="abe-fl">
        <div class="textbox" >
          <div  id="<?php echo "$funcid"; ?>-keyword-info" class="abe-fl"<?php if($search["_showsearch"]=="show"):?>style="display:none;"<?php endif; ?>>
             ...
             <input type="button" value="搜索" class="btn btn-org  mrg_10 " id="<?php echo $funcid;?>-keyword-search"  default-status="1"  onclick="<?php echo ($funcid); ?>_keyword_set(); return _asr.submit('<?php echo "$funcid"; ?>', '<?php echo "$funcid"; ?>-Search', '<?php echo U("UserSummary/index?func=search&") ; ?>',''); " />
             <input id="<?php echo $funcid;?>-search-buttc" type="button" value="导出" class="btn btn-blue mrg_10 " default-status="1" onclick="return _asr.showExport('<?php echo "$funcid"; ?>', '<?php echo "$funcid"; ?>-Search', '<?php echo U("UserSummary/index?func=export&") ; ?>',<?php echo $p ?>); " />
          </div>
      ...
      <div class="abe-fr">
        <a href="javascript:void(0);" class="mrg_15 vi-blue search-hide" <?php if($search["_showsearch"]=="hide"):?>style="display:none;"<?php endif; ?>><i class="iconfont">&#xe673;</i>收起搜索</a>
          ...
          <?php if (isset($rights['add']) && $rights['add']): ?>
               <input type="button" value="新增用户" class="btn btn-blue mrg_10 " onclick="return _asr.popupFun('<?php echo U("/Home/User/index?func=add&") ; ?>', '<?php echo filterFuncId("/Home/User/index?func=add&","");?>'); " />
          <?php endif; ?>
    ...
    <div class="screening"  >
      <form action="<?php echo U('UserSummary/index?func=search'); ?>" id="<?php echo "$funcid"; ?>-Search" method="get">
                ...
                <ul class="form form-mod-new" id="<?php echo $funcid;?>-search-Info">
                  <li>
                      ...
                      <div class="unit-mid">
                          <div class="dropdown" id="<?php echo ($funcid); ?>_status">
                           ...
                           <?php $keyvalue = table_User_status(); if(is_array($keyvalue)){ $i = 0; $__LIST__ = $keyvalue; ?>
                  ...
                  <li>
                      ...
                      <div class="unit-mid">
                          <div class="dropdown" id="<?php echo ($funcid); ?>_side">
                             <select class="pbsele dropdown0" name="side">
                                <option value="" <?php if($search['side'] == ''): ?> selected="selected" <?php endif;?> ></option>
                               <?php
 $keyvalue = table_User_side(); if(is_array($keyvalue)){ $i = 0; $__LIST__ = $keyvalue; ?>
                                      <?php foreach($__LIST__ as $key=>$item): ++$i; ?>
                                   <option value="<?php echo $item['id']; ?>" <?php if($item['id'] == $search['side']): ?> selected="selected" <?php endif;?>><?php echo charlevel($item['level']).$item['name']; ?></option>
                                      <?php endforeach; ?>
                               <?php } ?>
                             </select>
                          </div>
 ...
 $keyvalue = table_Org(); if(is_array($keyvalue)){ $i = 0; $__LIST__ = $keyvalue; ?>
                  ...
                  <li>
                      <div class="unit-left"> 选择性别</div>
                      <div class="unit-mid">
                          <div class="dropdown" id="<?php echo ($funcid); ?>_sex">
                             <select class="pbsele dropdown0" name="sex">
                                <option value="" <?php if($search['sex'] == ''): ?> selected="selected" <?php endif;?> ></option>
                               <?php
 $keyvalue = table_User_sex(); if(is_array($keyvalue)){ $i = 0; $__LIST__ = $keyvalue; ?>
                                      <?php foreach($__LIST__ as $key=>$item): ++$i; ?>
                                   <option value="<?php echo $item['id']; ?>" <?php if($item['id'] == $search['sex']): ?> selected="selected" <?php endif;?>><?php echo charlevel($item['level']).$item['name']; ?></option>
                                      <?php endforeach; ?>
                               <?php } ?>
                             </select>
                          </div>
                  ...
                  <li>
                      <div class="unit-left"> 手机号码</div>
                      <div class="unit-mid">
                          <div class="textbox">
                              <input type="text" class="pbtxt txt0" name="mobilephone"  value="<?php echo $search['mobilephone']; ?>"   placeholder=" 输入%可进行匹配模糊搜索 ">
                          </div>
                          <div class="prompt" style="display:none">
                              <div class="error"><i class="iconfont">&#xe616;</i></div>
                          </div>
                  ...
                  <li>
                      <div class="unit-left"> 是否管理员</div>
                      <div class="unit-mid">
                          <div class="dropdown" id="<?php echo ($funcid); ?>_superadmin">
                             <div class="selebtn">
                                <input type="hidden"  name="superadmin" value="<?php echo $search['superadmin']; ?>">
                                <a href="javascript:void(0);" onclick="_asr.selebtn_click(this,'');" class="<?php  echo $search['superadmin']!=""?"":"active"; ?>">全部</a>
                           <?php $keyvalue = table_User_superadmin(); if(is_array($keyvalue)){ $i = 0; $__LIST__ = $keyvalue; ?>
                               <?php foreach($__LIST__ as $key=>$item): ++$i; ?>
                                 <a href="javascript:void(0);" onclick="_asr.selebtn_click(this,'<?php echo $item['id'];?>');" class="<?php  echo $search['superadmin']!=$item['id']?"":"active"; ?>"><?php echo $item['name']; ?></a>
                               <?php if($i==2) break; ?>
                               <?php endforeach; ?>
                           <?php } ?>
                             </div>
                  ...
                  <li>
                      <div class="unit-left"> 密码错误次数</div>
                      <div class="unit-mid">
                          <div class="textbox">
                              <input type="text" class="pbtxt txt1" name="errpwd_count"  value="<?php echo $search['errpwd_count']; ?>"  >
                              <em class="space-line">-</em>
                              <input type="text" class="pbtxt txt1" name="errpwd_count2" value="<?php echo $search['errpwd_count2']; ?>"  >
                          </div>
                          <div class="prompt" style="display:none">
                              <div class="error"><i class="iconfont">&#xe616;</i></div>
                          </div>
                  ...
                  <div class="sub-box sub-box3">
                    <div class="pbtab abe-fl" >
                      ...
                      <a href="#" onclick="return _asr.tabsheet('<?php echo $funcid;?>', '<?php echo "$funcid"; ?>-Search', 'suoding');" <?php if($search['_tab'] == 'suoding'): ?> class="current"<?php endif;?>>锁定</a>
          ...
          <?php if (isset($rights['search']) && $rights['search']): ?>
               <input type="button" value="搜索" class="btn btn-org  mrg_10 " onclick="return _asr.submit('<?php echo "$funcid"; ?>', '<?php echo "$funcid"; ?>-Search', '<?php echo U("UserSummary/index?func=search&") ; ?>',''); " />
          <?php endif; ?>
          ...
          <?php if (isset($rights['export']) && $rights['export']): ?>
               <input type="button" value="导出" class="btn btn-blue mrg_10 " onclick="return _asr.showExport('<?php echo "$funcid"; ?>', '<?php echo "$funcid"; ?>-Search', '<?php echo U("UserSummary/index?func=export&") ; ?>',<?php echo $p ?>); " />
          <?php endif; ?>

                    <em class="pdr_20"></em>
                    <a href="javascript:void(0);" class="table-set <?php echo count($colshow)>0?"vi-blue":"abe-gray3"; ?>"  onclick="return _asr.popupFun('<?php echo U("/Summary/UserSummary/index?func=columnsetting&") ; ?>','<?php echo filterFuncId("/UserSummary/column","");?>');  " ><em class="iconfont abe-ft14 mrg_5">&#xe60a;</em>设置</a>
                    </div>
                  </div>
      </form>
    </div>
  ...
  <div class="wrap-nmd-box">
    <div class="wrap-master ">
      ...
      <div class="list-scroll">
        <div class="table-box">
          <div class="table-in">
            <form id="<?php echo "$funcid"; ?>-Result"  action="<?php U('UserSummary/op'); ?>" method="post">
          ...
          <!-- 序号        <col style="width: 40px ;">   -->
                           ...
                           <col style="width: 80px ; <?php if(isset($colshow["side"]) && $colshow["side"]=="0"): ?>display:none;<?php endif; ?> ">  <!-- 类型 -->
                           <col style="width: 80px ; <?php if(isset($colshow["org_id"]) && $colshow["org_id"]=="0"): ?>display:none;<?php endif; ?> ">  <!-- 库链 -->
                           <col style="width: 80px ; <?php if(isset($colshow["code"]) && $colshow["code"]=="0"): ?>display:none;<?php endif; ?> ">  <!-- 用户 -->
                           <col style="width: 100px ; <?php if(isset($colshow["name"]) && $colshow["name"]=="0"): ?>display:none;<?php endif; ?> ">  <!-- 姓名 -->
                           <col style="width: 80px ; <?php if(isset($colshow["sex"]) && $colshow["sex"]=="0"): ?>display:none;<?php endif; ?> ">  <!-- 性别 -->
                           <col style="width: 80px ; <?php if(isset($colshow["mobilephone"]) && $colshow["mobilephone"]=="0"): ?>display:none;<?php endif; ?> ">  <!-- 手机号码 -->
                           <col style="width: 80px ; <?php if(isset($colshow["superadmin"]) && $colshow["superadmin"]=="0"): ?>display:none;<?php endif; ?> ">  <!-- 管理员 -->
                           <col style="width: 100px ; <?php if(isset($colshow["errpwd_count"]) && $colshow["errpwd_count"]=="0"): ?>display:none;<?php endif; ?> ">  <!-- 密码错误次数 -->
          ...
          <!-- 序号       <th>序号</th>   -->
                          ...
                          <th <?php if(isset($colshow["side"]) && $colshow["side"]=="0"): ?> style="display:none" <?php endif; ?>>类型</th>
                          <th <?php if(isset($colshow["org_id"]) && $colshow["org_id"]=="0"): ?> style="display:none" <?php endif; ?>>库链</th>
                          <th <?php if(isset($colshow["code"]) && $colshow["code"]=="0"): ?> style="display:none" <?php endif; ?> class="abe-txtl">用户</th>
                          <th <?php if(isset($colshow["name"]) && $colshow["name"]=="0"): ?> style="display:none" <?php endif; ?> class="abe-txtl">姓名</th>
                          <th <?php if(isset($colshow["sex"]) && $colshow["sex"]=="0"): ?> style="display:none" <?php endif; ?>>性别</th>
                          <th <?php if(isset($colshow["mobilephone"]) && $colshow["mobilephone"]=="0"): ?> style="display:none" <?php endif; ?> class="abe-txtl">手机号码</th>
                          <th <?php if(isset($colshow["superadmin"]) && $colshow["superadmin"]=="0"): ?> style="display:none" <?php endif; ?>>管理员</th>
                          <th <?php if(isset($colshow["errpwd_count"]) && $colshow["errpwd_count"]=="0"): ?> style="display:none" <?php endif; ?>>密码错误次数</th>
          ...
          <?php if (isset($rights['master_view']) && $rights['master_view']): ?>
               <a href="javascript:void(0);"  class=" vi-blue vi-blue " onclick="return _asr.openLink('<?php echo U("/Home/User/index?func=view&id=$master[id]") ; ?>', '<?php echo filterFuncId(U("/Home/User/index?func=view&id=$master[id]"),"");?>' , '<?php echo tabTitle("用户","$master[code]") ; ?>' ,0); "><i class="iconfont abe-ft18">&#xe62e;</i></a>
          <?php endif; ?>
          ...
          <?php if (isset($rights['master_edit']) && $rights['master_edit']): ?>
               <a href="javascript:void(0);"  class=" vi-blue vi-blue " onclick="return _asr.popupFun('<?php echo U("/Home/User/index?func=edit&id=$master[id]") ; ?>', '<?php echo filterFuncId("/Home/User/index?func=edit&id=$master[id]","");?>'); "><i class="iconfont abe-ft15">&#xe63f;</i></a>
          <?php endif; ?>
          ...
          <?php if ($master['status']==0): ?>
               <a href="javascript:void(0);"  class=" vi-blue vi-blue " onclick="return _asr.confirm('确认操作', '请确认是否删除用户?', '<?php echo "用户 : $master[code]"; ?>', '<?php echo U("/Home/User/index?func=delete&type=1&id=$master[id]") ; ?>','',''); "><i class="iconfont vi-red">&#xe61d;</i></a>
          <?php endif; ?>
          <?php endif; ?></td>


                                  <td style=" <?php if(isset($colshow["status"]) && $colshow["status"]=="0"): ?>display:none<?php endif; ?> " ><?php echo get_table_User_status("$master[status]","name","") ; ?></td>
                                  <td style=" <?php if(isset($colshow["side"]) && $colshow["side"]=="0"): ?>display:none<?php endif; ?> " ><?php echo get_table_User_side("$master[side]","name","") ; ?></td>
                                  ...
                                  <td style=" <?php if(isset($colshow["code"]) && $colshow["code"]=="0"): ?>display:none<?php endif; ?> " class=" abe-txtl "><a href="javascript:void(0);" class="vi-blue"  onclick="return _asr.openLink('<?php echo U("/Home/User/index?func=view&id=$master[id]"); ?>','<?php echo filterFuncId( U("/Home/User/index?func=view&id=$master[id]") ,"");?>', '<?php echo tabTitle("用户","$master[code]") ; ?>' ,0); " ><?php echo $master["code"] ; ?></a></td>
                                  <td style=" <?php if(isset($colshow["name"]) && $colshow["name"]=="0"): ?>display:none<?php endif; ?> " class=" abe-txtl "><?php echo $master["name"] ; ?></td>
                                  <td style=" <?php if(isset($colshow["sex"]) && $colshow["sex"]=="0"): ?>display:none<?php endif; ?> " ><?php echo get_table_User_sex("$master[sex]","name","") ; ?></td>
                                  <td style=" <?php if(isset($colshow["mobilephone"]) && $colshow["mobilephone"]=="0"): ?>display:none<?php endif; ?> " class=" abe-txtl "><?php echo $master["mobilephone"] ; ?></td>
                                  <td style=" <?php if(isset($colshow["superadmin"]) && $colshow["superadmin"]=="0"): ?>display:none<?php endif; ?> " ><?php echo get_table_User_superadmin("$master[superadmin]","name","") ; ?></td>
                                  <td style=" <?php if(isset($colshow["errpwd_count"]) && $colshow["errpwd_count"]=="0"): ?>display:none<?php endif; ?> " class=" <?php if ($master['errpwd_count']<0): ?> abe-red <?php endif; ?> "><?php echo system_format("N3", $master["errpwd_count"],1) ; ?>


          <?php if (isset($rights['master_unlock']) && $rights['master_unlock']): ?>
          <?php if ($master['errpwd_count']>9): ?>
               <a href="javascript:void(0);"  class=" btn btn-xs btn-blue " onclick="return _asr.confirm('确认操作', '请确认是否解锁?', '<?php echo "用户=$master[name]"; ?>', '<?php echo U("/Home/user/index?func=unlock&id=$master[id]") ; ?>','',''); "> 解锁</a>
          <?php endif; ?>
          <?php endif; ?></td>
          ...
          <?php if (!$master['status']): ?>
               <input type="button" value="有效" class="btn btn-sm btn-blue mlg_10 " onclick="return _asr.popupFun('<?php echo U("/Home/User/index?func=status_on&id=$master[id]") ; ?>', '<?php echo filterFuncId("/Home/User/index?func=status_on&id=$master[id]","");?>'); " />
          <?php endif; ?>
          <?php endif; ?>
          ...
          <?php if ($master['status']=='1'): ?>
               <input type="button" value="无效" class="btn btn-sm btn-org mlg_10 " onclick="return _asr.popupFun('<?php echo U("/Home/User/index?func=status_off&id=$master[id]") ; ?>', '<?php echo filterFuncId("/Home/User/index?func=status_off&id=$master[id]","");?>'); " />
          <?php endif; ?>
          <?php endif; ?></td>
    ...
    <script>
        ...
        function <?php echo $funcid; ?>_clearsearch(_frm){
            ...
            _asr.setvaluebyname(_frm,"sex","");
            _asr.setvaluebyname(_frm,"mobilephone","");
            _asr.setvaluebyname(_frm,"superadmin","");
            _asr.setvaluebyname(_frm,"errpwd_count","");
            _asr.setvaluebyname(_frm,"errpwd_count2","");
    ...
    <?php echo W('Summary/javascript',array('UserSummary'));?>
