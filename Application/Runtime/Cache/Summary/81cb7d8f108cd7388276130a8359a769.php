...
<div toplayer="1" class="wrap-box wrap-nmd wrap-style00 " id="<?php echo $funcid;?>" summaryid="SubcodeSummary" baseurl="<?php echo U('SubcodeSummary/index'); ?>">
  <div class="wrap-box-info ">

    <div class="wrap-title abe-ofl">
      <div class="tit abe-fl" style="width: 450px;">系统分类列表</div>
      <div class="abe-fl">
        <div class="textbox" >
          <div  id="<?php echo "$funcid"; ?>-keyword-info" class="abe-fl"<?php if($search["_showsearch"]=="show"):?>style="display:none;"<?php endif; ?>>
             ...
             <input type="button" value="搜索" class="btn btn-org  mrg_10 " id="<?php echo $funcid;?>-keyword-search"  default-status="1"  onclick="<?php echo ($funcid); ?>_keyword_set(); return _asr.submit('<?php echo "$funcid"; ?>', '<?php echo "$funcid"; ?>-Search', '<?php echo U("SubcodeSummary/index?func=search&") ; ?>',''); " />
             <input id="<?php echo $funcid;?>-search-buttc" type="button" value="导出" class="btn btn-blue mrg_10 " default-status="1" onclick="return _asr.showExport('<?php echo "$funcid"; ?>', '<?php echo "$funcid"; ?>-Search', '<?php echo U("SubcodeSummary/index?func=export&") ; ?>',<?php echo $p ?>); " />
          </div>
    ...
    <div class="screening"  >
      <form action="<?php echo U('SubcodeSummary/index?func=search'); ?>" id="<?php echo "$funcid"; ?>-Search" method="get">
          ...
          <?php if (isset($rights['search']) && $rights['search']): ?>
               <input type="button" value="搜索" class="btn btn-org  mrg_10 " onclick="return _asr.submit('<?php echo "$funcid"; ?>', '<?php echo "$funcid"; ?>-Search', '<?php echo U("SubcodeSummary/index?func=search&") ; ?>',''); " />
          <?php endif; ?>
          ...
          <?php if (isset($rights['export']) && $rights['export']): ?>
               <input type="button" value="导出" class="btn btn-blue mrg_10 " onclick="return _asr.showExport('<?php echo "$funcid"; ?>', '<?php echo "$funcid"; ?>-Search', '<?php echo U("SubcodeSummary/index?func=export&") ; ?>',<?php echo $p ?>); " />
          <?php endif; ?>

                    <em class="pdr_20"></em>
                    <a href="javascript:void(0);" class="table-set <?php echo count($colshow)>0?"vi-blue":"abe-gray3"; ?>"  onclick="return _asr.popupFun('<?php echo U("/Summary/SubcodeSummary/index?func=columnsetting&") ; ?>','<?php echo filterFuncId("/SubcodeSummary/column","");?>');  " ><em class="iconfont abe-ft14 mrg_5">&#xe60a;</em>设置</a>
                    </div>
                  </div>
      </form>
    </div>
  ...
  <div class="wrap-nmd-box">
    <div class="wrap-master ">
      ...
      <div class="list-scroll">
        <div class="table-box">
          <div class="table-in">
            <form id="<?php echo "$funcid"; ?>-Result"  action="<?php U('SubcodeSummary/op'); ?>" method="post">
          ...
          <!-- 序号        <col style="width: 40px ;">   -->
                           ...
                           <col style="width: 80px ; <?php if(isset($colshow["newcolumn"]) && $colshow["newcolumn"]=="0"): ?>display:none;<?php endif; ?> ">  <!-- 设置 -->
          ...
          <!-- 序号       <th>序号</th>   -->
                          ...
                          <th <?php if(isset($colshow["newcolumn"]) && $colshow["newcolumn"]=="0"): ?> style="display:none" <?php endif; ?>>设置</th>
                           <th></th >
                        </tr>
          ...
          <?php if (isset($rights['master_maint']) && $rights['master_maint']): ?>
               <a href="javascript:void(0);"  class=" btn btn-xs btn-blue " onclick="return _asr.openLink('<?php echo U("/Summary/SubcodeMaintSummary/index?func=search&type=$master[code]") ; ?>', '<?php echo "$funcid"; ?>' , '分类信息维护' ,0); "> 维护</a>
          <?php endif; ?></td>
    ...
    <?php echo W('Summary/javascript',array('SubcodeSummary'));?>
