...
<div toplayer="1" class="wrap-box wrap-nmd wrap-style00 " id="<?php echo $funcid;?>" summaryid="RoleSummary" baseurl="<?php echo U('RoleSummary/index'); ?>">
  <div class="wrap-box-info ">

    <div class="wrap-title abe-ofl">
      <div class="tit abe-fl" style="width: 450px;">角色列表</div>
      <div class="abe-fl">
        <div class="textbox" >
          <div  id="<?php echo "$funcid"; ?>-keyword-info" class="abe-fl"<?php if($search["_showsearch"]=="show"):?>style="display:none;"<?php endif; ?>>
             ...
             <input type="button" value="搜索" class="btn btn-org  mrg_10 " id="<?php echo $funcid;?>-keyword-search"  default-status="1"  onclick="<?php echo ($funcid); ?>_keyword_set(); return _asr.submit('<?php echo "$funcid"; ?>', '<?php echo "$funcid"; ?>-Search', '<?php echo U("RoleSummary/index?func=search&") ; ?>',''); " />
             <input id="<?php echo $funcid;?>-search-buttc" type="button" value="导出" class="btn btn-blue mrg_10 " default-status="1" onclick="return _asr.showExport('<?php echo "$funcid"; ?>', '<?php echo "$funcid"; ?>-Search', '<?php echo U("RoleSummary/index?func=export&") ; ?>',<?php echo $p ?>); " />
          </div>
      ...
      <div class="abe-fr">
        <a href="javascript:void(0);" class="mrg_15 vi-blue search-hide" <?php if($search["_showsearch"]=="hide"):?>style="display:none;"<?php endif; ?>><i class="iconfont">&#xe673;</i>收起搜索</a>
          ...
          <?php if (isset($rights['add']) && $rights['add']): ?>
               <input type="button" value="新增角色" class="btn btn-blue mrg_10 " onclick="return _asr.popupFun('<?php echo U("/Home/Role/index?func=add&") ; ?>', '<?php echo filterFuncId("/Home/Role/index?func=add&","");?>'); " />
          <?php endif; ?>
    ...
    <div class="screening"  >
      <form action="<?php echo U('RoleSummary/index?func=search'); ?>" id="<?php echo "$funcid"; ?>-Search" method="get">
                  ...
                  <li>
                      ...
                      <div class="unit-mid">
                          <div class="dropdown" id="<?php echo ($funcid); ?>_status">
                           ...
                           <?php $keyvalue = table_Role_status(); if(is_array($keyvalue)){ $i = 0; $__LIST__ = $keyvalue; ?>
          ...
          <?php if (isset($rights['search']) && $rights['search']): ?>
               <input type="button" value="搜索" class="btn btn-org  mrg_10 " onclick="return _asr.submit('<?php echo "$funcid"; ?>', '<?php echo "$funcid"; ?>-Search', '<?php echo U("RoleSummary/index?func=search&") ; ?>',''); " />
          <?php endif; ?>
          ...
          <?php if (isset($rights['export']) && $rights['export']): ?>
               <input type="button" value="导出" class="btn btn-blue mrg_10 " onclick="return _asr.showExport('<?php echo "$funcid"; ?>', '<?php echo "$funcid"; ?>-Search', '<?php echo U("RoleSummary/index?func=export&") ; ?>',<?php echo $p ?>); " />
          <?php endif; ?>

                    <em class="pdr_20"></em>
                    <a href="javascript:void(0);" class="table-set <?php echo count($colshow)>0?"vi-blue":"abe-gray3"; ?>"  onclick="return _asr.popupFun('<?php echo U("/Summary/RoleSummary/index?func=columnsetting&") ; ?>','<?php echo filterFuncId("/RoleSummary/column","");?>');  " ><em class="iconfont abe-ft14 mrg_5">&#xe60a;</em>设置</a>
                    </div>
                  </div>
      </form>
    </div>
  ...
  <div class="wrap-nmd-box">
    <div class="wrap-master ">
      ...
      <div class="list-scroll">
        <div class="table-box">
          <div class="table-in">
            <form id="<?php echo "$funcid"; ?>-Result"  action="<?php U('RoleSummary/op'); ?>" method="post">
          ...
          <!-- 序号        <col style="width: 40px ;">   -->
                           ...
                           <col style="width: 100px ; <?php if(isset($colshow["name"]) && $colshow["name"]=="0"): ?>display:none;<?php endif; ?> ">  <!-- 角色 -->
                           <col style="width: 80px ; <?php if(isset($colshow["newcolumn"]) && $colshow["newcolumn"]=="0"): ?>display:none;<?php endif; ?> ">  <!-- 权限设置 -->
          ...
          <!-- 序号       <th>序号</th>   -->
                          ...
                          <th <?php if(isset($colshow["name"]) && $colshow["name"]=="0"): ?> style="display:none" <?php endif; ?> class="abe-txtl">角色</th>
                          <th <?php if(isset($colshow["newcolumn"]) && $colshow["newcolumn"]=="0"): ?> style="display:none" <?php endif; ?>>权限设置</th>
                           <th></th >
                        </tr>
          ...
          <?php if (isset($rights['master_view']) && $rights['master_view']): ?>
               <a href="javascript:void(0);"  class=" vi-blue vi-blue " onclick="return _asr.popupFun('<?php echo U("/Home/Role/index?func=view&id=$master[id]") ; ?>', '<?php echo filterFuncId("/Home/Role/index?func=view&id=$master[id]","");?>'); "><i class="iconfont abe-ft18">&#xe62e;</i></a>
          <?php endif; ?>
          ...
          <?php endif; ?></td>
                                  ...
                                  <td style=" <?php if(isset($colshow["status"]) && $colshow["status"]=="0"): ?>display:none<?php endif; ?> " ><?php echo get_table_Role_status("$master[status]","name","") ; ?></td>
                                  <td style=" <?php if(isset($colshow["name"]) && $colshow["name"]=="0"): ?>display:none<?php endif; ?> " class=" abe-txtl "><?php echo $master["name"] ; ?></td>
                                  <td style=" <?php if(isset($colshow["newcolumn"]) && $colshow["newcolumn"]=="0"): ?>display:none<?php endif; ?> " >


          <?php if (isset($rights['master_user']) && $rights['master_user']): ?>
               <a href="javascript:void(0);"  class=" btn btn-xs btn-blue " onclick="return _asr.popupFun('<?php echo U("/Home/RoleNode/index?func=master_user&id=$master[id]") ; ?>', '<?php echo filterFuncId("/Home/RoleNode/index?func=master_user&id=$master[id]","");?>'); "> 绑用户</a>
          <?php endif; ?>



          <?php if (isset($rights['master_rights']) && $rights['master_rights']): ?>
               <a href="javascript:void(0);"  class=" btn btn-xs btn-blue " onclick="return _asr.popupFun('<?php echo U("/Home/RoleNode/index?func=master_rights&id=$master[id]") ; ?>', '<?php echo filterFuncId("/Home/RoleNode/index?func=master_rights&id=$master[id]","");?>'); "> 绑权限</a>
          <?php endif; ?></td>
    ...
    <?php echo W('Summary/javascript',array('RoleSummary'));?>
