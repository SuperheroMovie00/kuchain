...
<div toplayer="1" class="wrap-box wrap-nmd wrap-style00 " id="<?php echo $funcid;?>" summaryid="GoodsSummary" baseurl="<?php echo U('GoodsSummary/index'); ?>">
  <div class="wrap-box-info ">

    <div class="wrap-title abe-ofl">
      <div class="tit abe-fl" style="width: 450px;">联盟货品列表</div>
      <div class="abe-fl">
        <div class="textbox" >
          <div  id="<?php echo "$funcid"; ?>-keyword-info" class="abe-fl"<?php if($search["_showsearch"]=="show"):?>style="display:none;"<?php endif; ?>>
             ...
             <input type="button" value="搜索" class="btn btn-org  mrg_10 " id="<?php echo $funcid;?>-keyword-search"  default-status="1"  onclick="<?php echo ($funcid); ?>_keyword_set(); return _asr.submit('<?php echo "$funcid"; ?>', '<?php echo "$funcid"; ?>-Search', '<?php echo U("GoodsSummary/index?func=search&") ; ?>',''); " />
             <input id="<?php echo $funcid;?>-search-buttc" type="button" value="导出" class="btn btn-blue mrg_10 " default-status="1" onclick="return _asr.showExport('<?php echo "$funcid"; ?>', '<?php echo "$funcid"; ?>-Search', '<?php echo U("GoodsSummary/index?func=export&") ; ?>',<?php echo $p ?>); " />
          </div>
    ...
    <div class="screening"  >
      <form action="<?php echo U('GoodsSummary/index?func=search'); ?>" id="<?php echo "$funcid"; ?>-Search" method="get">
                ...
                <ul class="form form-mod-new" id="<?php echo $funcid;?>-search-Info">
                  <li>
                      ...
                      <div class="unit-mid">
                          <div class="dropdown" id="<?php echo ($funcid); ?>_status">
                           ...
                           <?php $keyvalue = table_Goods_status(); if(is_array($keyvalue)){ $i = 0; $__LIST__ = $keyvalue; ?>
                  ...
                  <li>
                      <div class="unit-left"> 机构原始码</div>
                      <div class="unit-mid">
                          <div class="textbox">
                              <input type="text" class="pbtxt txt0" name="org_goods_no"  value="<?php echo $search['org_goods_no']; ?>"   placeholder=" 输入%可进行匹配模糊搜索 ">
                          </div>
                          <div class="prompt" style="display:none">
                              <div class="error"><i class="iconfont">&#xe616;</i></div>
                          </div>
 ...
 $keyvalue = subcode('UOM_QTY'); if(is_array($keyvalue)){ $i = 0; $__LIST__ = $keyvalue; ?>
                  ...
                  <li>
                      <div class="unit-left"> 活跃等级</div>
                      <div class="unit-mid">
                          <div class="dropdown" id="<?php echo ($funcid); ?>_active">
                             <select class="pbsele dropdown0" name="active">
                                <option value="" <?php if($search['active'] == ''): ?> selected="selected" <?php endif;?> ></option>
                               <?php
 $keyvalue = table_Goods_active(); if(is_array($keyvalue)){ $i = 0; $__LIST__ = $keyvalue; ?>
                                      <?php foreach($__LIST__ as $key=>$item): ++$i; ?>
                                   <option value="<?php echo $item['id']; ?>" <?php if($item['id'] == $search['active']): ?> selected="selected" <?php endif;?>><?php echo charlevel($item['level']).$item['name']; ?></option>
                                      <?php endforeach; ?>
                               <?php } ?>
                             </select>
                          </div>
                  ...
                  <li>
                      <div class="unit-left"> 配货方式</div>
                      <div class="unit-mid">
                          <div class="dropdown" id="<?php echo ($funcid); ?>_assign_mode">
                             <div class="selebtn">
                                <input type="hidden"  name="assign_mode" value="<?php echo $search['assign_mode']; ?>">
                                <a href="javascript:void(0);" onclick="_asr.selebtn_click(this,'');" class="<?php  echo $search['assign_mode']!=""?"":"active"; ?>">全部</a>
                           <?php $keyvalue = table_Goods_assign_mode(); if(is_array($keyvalue)){ $i = 0; $__LIST__ = $keyvalue; ?>
                               <?php foreach($__LIST__ as $key=>$item): ++$i; ?>
                                 <a href="javascript:void(0);" onclick="_asr.selebtn_click(this,'<?php echo $item['id'];?>');" class="<?php  echo $search['assign_mode']!=$item['id']?"":"active"; ?>"><?php echo $item['name']; ?></a>
                               <?php if($i==2) break; ?>
                               <?php endforeach; ?>
                           <?php } ?>
                             </div>
                  ...
                  <div class="sub-box sub-box3">
                    <div class="pbtab abe-fl" >
                      ...
                      <a href="#" onclick="return _asr.tabsheet('<?php echo $funcid;?>', '<?php echo "$funcid"; ?>-Search', 'shiyong');" <?php if($search['_tab'] == 'shiyong'): ?> class="current"<?php endif;?>>使用</a>
                      <a href="#" onclick="return _asr.tabsheet('<?php echo $funcid;?>', '<?php echo "$funcid"; ?>-Search', 'tingzhi');" <?php if($search['_tab'] == 'tingzhi'): ?> class="current"<?php endif;?>>停止</a>
                    </div>
          ...
          <?php if (isset($rights['search']) && $rights['search']): ?>
               <input type="button" value="搜索" class="btn btn-org  mrg_10 " onclick="return _asr.submit('<?php echo "$funcid"; ?>', '<?php echo "$funcid"; ?>-Search', '<?php echo U("GoodsSummary/index?func=search&") ; ?>',''); " />
          <?php endif; ?>
          ...
          <?php if (isset($rights['export']) && $rights['export']): ?>
               <input type="button" value="导出" class="btn btn-blue mrg_10 " onclick="return _asr.showExport('<?php echo "$funcid"; ?>', '<?php echo "$funcid"; ?>-Search', '<?php echo U("GoodsSummary/index?func=export&") ; ?>',<?php echo $p ?>); " />
          <?php endif; ?>

                    <em class="pdr_20"></em>
                    <a href="javascript:void(0);" class="table-set <?php echo count($colshow)>0?"vi-blue":"abe-gray3"; ?>"  onclick="return _asr.popupFun('<?php echo U("/Summary/GoodsSummary/index?func=columnsetting&") ; ?>','<?php echo filterFuncId("/GoodsSummary/column","");?>');  " ><em class="iconfont abe-ft14 mrg_5">&#xe60a;</em>设置</a>
                    </div>
                  </div>
      </form>
    </div>
  ...
  <div class="wrap-nmd-box">
    <div class="wrap-master ">
      ...
      <div class="list-scroll">
        <div class="table-box">
          <div class="table-in">
            <form id="<?php echo "$funcid"; ?>-Result"  action="<?php U('GoodsSummary/op'); ?>" method="post">
          ...
          <!-- 序号        <col style="width: 40px ;">   -->
                           ...
                           <col style="width: 100px ; <?php if(isset($colshow["name"]) && $colshow["name"]=="0"): ?>display:none;<?php endif; ?> ">  <!-- 货品名称 -->
                           <col style="width: 80px ; <?php if(isset($colshow["materials"]) && $colshow["materials"]=="0"): ?>display:none;<?php endif; ?> ">  <!-- 材质 -->
                           <col style="width: 80px ; <?php if(isset($colshow["org_goods_no"]) && $colshow["org_goods_no"]=="0"): ?>display:none;<?php endif; ?> ">  <!-- 机构原始码 -->
                           ...
                           <col style="width: 80px ; <?php if(isset($colshow["active"]) && $colshow["active"]=="0"): ?>display:none;<?php endif; ?> ">  <!-- 活跃等级 -->
                           <col style="width: 80px ; <?php if(isset($colshow["assign_mode"]) && $colshow["assign_mode"]=="0"): ?>display:none;<?php endif; ?> ">  <!-- 配货方式 -->
          ...
          <!-- 序号       <th>序号</th>   -->
                          ...
                          <th <?php if(isset($colshow["name"]) && $colshow["name"]=="0"): ?> style="display:none" <?php endif; ?> class="abe-txtl">货品名称</th>
                          <th <?php if(isset($colshow["materials"]) && $colshow["materials"]=="0"): ?> style="display:none" <?php endif; ?> class="abe-txtl">材质</th>
                          <th <?php if(isset($colshow["org_goods_no"]) && $colshow["org_goods_no"]=="0"): ?> style="display:none" <?php endif; ?> class="abe-txtl">机构原始码</th>
                          ...
                          <th <?php if(isset($colshow["active"]) && $colshow["active"]=="0"): ?> style="display:none" <?php endif; ?>>活跃等级</th>
                          <th <?php if(isset($colshow["assign_mode"]) && $colshow["assign_mode"]=="0"): ?> style="display:none" <?php endif; ?>>配货方式</th>
                          <th>状态调整</th>
                           <th></th >
                        </tr>
          ...
          <?php if (isset($rights['master_view']) && $rights['master_view']): ?>
               <a href="javascript:void(0);"  class=" vi-blue vi-blue " onclick="return _asr.openLink('<?php echo U("/Home/Goods/index?func=view&id=$master[id]") ; ?>', '<?php echo filterFuncId(U("/Home/Goods/index?func=view&id=$master[id]"),"");?>' , '<?php echo tabTitle("id","$master[goods_no]") ; ?>' ,0); "><i class="iconfont abe-ft18">&#xe62e;</i></a>
          <?php endif; ?>
          ...
          <?php if ($master['status']=='0'): ?>
               <a href="javascript:void(0);"  class=" vi-blue vi-blue " onclick="return _asr.popupFun('<?php echo U("/Home/GoodsStyle/index?func=create&id=$master[id]") ; ?>', '<?php echo filterFuncId("/Home/GoodsStyle/index?func=create&id=$master[id]","");?>'); "><i class="iconfont abe-ft15">&#xe63f;</i></a>
          <?php endif; ?>
          <?php endif; ?>
          ...
          <?php if ($master['status']==0): ?>
               <a href="javascript:void(0);"  class=" vi-blue vi-blue " onclick="return _asr.confirm('确认操作', '请确认是否删除货品?', '<?php echo "货品 : $master[goods_no]"; ?>', '<?php echo U("/Home/Goods/index?func=delete&type=1&id=$master[id]") ; ?>','',''); "><i class="iconfont vi-red">&#xe61d;</i></a>
          <?php endif; ?>
          <?php endif; ?></td>


                                  <td style=" <?php if(isset($colshow["status"]) && $colshow["status"]=="0"): ?>display:none<?php endif; ?> " ><?php echo get_table_Goods_status("$master[status]","name","") ; ?></td>
                                  <td style=" <?php if(isset($colshow["goods_no"]) && $colshow["goods_no"]=="0"): ?>display:none<?php endif; ?> " class=" abe-txtl "><a href="javascript:void(0);" class="vi-blue"  onclick="return _asr.openLink('<?php echo U("/Home/Goods/index?func=view&no=$master[goods_no]"); ?>','<?php echo filterFuncId( U("/Home/Goods/index?func=view&no=$master[goods_no]") ,"");?>', 'id详情' ,0); " ><?php echo $master["goods_no"] ; ?></a></td>
                                  ...
                                  <td style=" <?php if(isset($colshow["org_goods_no"]) && $colshow["org_goods_no"]=="0"): ?>display:none<?php endif; ?> " class=" abe-txtl "><?php echo $master["org_goods_no"] ; ?></td>
                                  ...
                                  <td style=" <?php if(isset($colshow["active"]) && $colshow["active"]=="0"): ?>display:none<?php endif; ?> " ><?php echo get_table_Goods_active("$master[active]","name","") ; ?></td>
                                  <td style=" <?php if(isset($colshow["assign_mode"]) && $colshow["assign_mode"]=="0"): ?>display:none<?php endif; ?> " ><?php echo get_table_Goods_assign_mode("$master[assign_mode]","name","") ; ?></td>
                                  <td>


          <?php if (isset($rights['status_on']) && $rights['status_on']): ?>
          <?php if (!$master['status']): ?>
               <input type="button" value="转使用" class="btn btn-sm btn-blue mlg_10 " onclick="return _asr.popupFun('<?php echo U("/Home/Goods/index?func=status_on&id=$master[id]") ; ?>', '<?php echo filterFuncId("/Home/Goods/index?func=status_on&id=$master[id]","");?>'); " />
          <?php endif; ?>
          <?php endif; ?>
          ...
          <?php if ($master['status']=='1'): ?>
               <input type="button" value="转停止" class="btn btn-sm btn-org mlg_10 " onclick="return _asr.popupFun('<?php echo U("/Home/Goods/index?func=status_off&id=$master[id]") ; ?>', '<?php echo filterFuncId("/Home/Goods/index?func=status_off&id=$master[id]","");?>'); " />
          <?php endif; ?>
          <?php endif; ?></td>
    ...
    <script>
        ...
        function <?php echo $funcid; ?>_clearsearch(_frm){
            ...
            _asr.setvaluebyname(_frm,"org_goods_no","");
            _asr.setvaluebyname(_frm,"uom_weight","");
            _asr.setvaluebyname(_frm,"uom_qty","");
            _asr.setvaluebyname(_frm,"active","");
            _asr.setvaluebyname(_frm,"assign_mode","");
    ...
    <?php echo W('Summary/javascript',array('GoodsSummary'));?>
