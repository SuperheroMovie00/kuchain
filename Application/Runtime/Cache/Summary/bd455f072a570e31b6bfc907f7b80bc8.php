...
<div toplayer="1" class="wrap-box wrap-nmd wrap-style00 " id="<?php echo $funcid;?>" summaryid="LogTradeSummary" baseurl="<?php echo U('LogTradeSummary/index'); ?>">
  <div class="wrap-box-info ">

    <div class="wrap-title abe-ofl">
      <div class="tit abe-fl" style="width: 450px;">交易日志列表</div>
      <div class="abe-fl">
        <div class="textbox" >
          <div  id="<?php echo "$funcid"; ?>-keyword-info" class="abe-fl"<?php if($search["_showsearch"]=="show"):?>style="display:none;"<?php endif; ?>>
             ...
             <input type="button" value="搜索" class="btn btn-org  mrg_10 " id="<?php echo $funcid;?>-keyword-search"  default-status="1"  onclick="<?php echo ($funcid); ?>_keyword_set(); return _asr.submit('<?php echo "$funcid"; ?>', '<?php echo "$funcid"; ?>-Search', '<?php echo U("LogTradeSummary/index?func=search&") ; ?>',''); " />
             <input id="<?php echo $funcid;?>-search-buttc" type="button" value="导出" class="btn btn-blue mrg_10 " default-status="1" onclick="return _asr.showExport('<?php echo "$funcid"; ?>', '<?php echo "$funcid"; ?>-Search', '<?php echo U("LogTradeSummary/index?func=export&") ; ?>',<?php echo $p ?>); " />
          </div>
    ...
    <div class="screening"  >
      <form action="<?php echo U('LogTradeSummary/index?func=search'); ?>" id="<?php echo "$funcid"; ?>-Search" method="get">
                ...
                <ul class="form form-mod-new" id="<?php echo $funcid;?>-search-Info">
                  ...
                  <li>
                      <div class="unit-left"> 交易</div>
                      <div class="unit-mid">
                          <div class="textbox">
                              <input type="text" class="pbtxt txt0" name="trade_id"  value="<?php echo $search['trade_id']; ?>"  >
                          </div>
                          <div class="prompt" style="display:none">
                              <div class="error"><i class="iconfont">&#xe616;</i></div>
                          </div>
          ...
          <?php if (isset($rights['search']) && $rights['search']): ?>
               <input type="button" value="搜索" class="btn btn-org  mrg_10 " onclick="return _asr.submit('<?php echo "$funcid"; ?>', '<?php echo "$funcid"; ?>-Search', '<?php echo U("LogTradeSummary/index?func=search&") ; ?>',''); " />
          <?php endif; ?>
          ...
          <?php if (isset($rights['export']) && $rights['export']): ?>
               <input type="button" value="导出" class="btn btn-blue mrg_10 " onclick="return _asr.showExport('<?php echo "$funcid"; ?>', '<?php echo "$funcid"; ?>-Search', '<?php echo U("LogTradeSummary/index?func=export&") ; ?>',<?php echo $p ?>); " />
          <?php endif; ?>

                    <em class="pdr_20"></em>
                    <a href="javascript:void(0);" class="table-set <?php echo count($colshow)>0?"vi-blue":"abe-gray3"; ?>"  onclick="return _asr.popupFun('<?php echo U("/Summary/LogTradeSummary/index?func=columnsetting&") ; ?>','<?php echo filterFuncId("/LogTradeSummary/column","");?>');  " ><em class="iconfont abe-ft14 mrg_5">&#xe60a;</em>设置</a>
                    </div>
                  </div>
      </form>
    </div>
  ...
  <div class="wrap-nmd-box">
    <div class="wrap-master ">
      ...
      <div class="list-scroll">
        <div class="table-box">
          <div class="table-in">
            <form id="<?php echo "$funcid"; ?>-Result"  action="<?php U('LogTradeSummary/op'); ?>" method="post">
          ...
          <!-- 序号        <col style="width: 40px ;">   -->
                           ...
                           <col style="width: 80px ; <?php if(isset($colshow["trade_id"]) && $colshow["trade_id"]=="0"): ?>display:none;<?php endif; ?> ">  <!-- 交易 -->
                           <col style="width: 80px ; <?php if(isset($colshow["trade_no"]) && $colshow["trade_no"]=="0"): ?>display:none;<?php endif; ?> ">  <!-- 交易号码 -->
                           <col style="width: 100px ; <?php if(isset($colshow["subject"]) && $colshow["subject"]=="0"): ?>display:none;<?php endif; ?> ">  <!-- 日志标题 -->
          ...
          <!-- 序号       <th>序号</th>   -->
                          ...
                          <th <?php if(isset($colshow["trade_id"]) && $colshow["trade_id"]=="0"): ?> style="display:none" <?php endif; ?>>交易</th>
                          <th <?php if(isset($colshow["trade_no"]) && $colshow["trade_no"]=="0"): ?> style="display:none" <?php endif; ?> class="abe-txtl">交易号码</th>
                          <th <?php if(isset($colshow["subject"]) && $colshow["subject"]=="0"): ?> style="display:none" <?php endif; ?> class="abe-txtl">日志标题</th>
                        ...
                        <?php if(is_array($list)): $i = 0; $__LIST__ = $list; if( count($__LIST__) == 0) : echo ""; else: foreach($__LIST__ as $key=>$master): $mod = ($i % 2 );++$i; ?>
                                  ...
                                  <td style=" <?php if(isset($colshow["trade_id"]) && $colshow["trade_id"]=="0"): ?>display:none<?php endif; ?> " ><?php echo $master["trade_id"] ; ?></td>
                                  <td style=" <?php if(isset($colshow["trade_no"]) && $colshow["trade_no"]=="0"): ?>display:none<?php endif; ?> " class=" abe-txtl "><a href="javascript:void(0);" class="vi-blue"  onclick="return _asr.openLink('<?php echo U("/Home/Trade/index?func=view&id=$master[trade_id]"); ?>','<?php echo filterFuncId( U("/Home/Trade/index?func=view&id=$master[trade_id]") ,"");?>', '<?php echo tabTitle("交易","$master[trade_no]","RIGHT","8") ; ?>' ,0); " ><?php echo $master["trade_no"] ; ?></a></td>
    ...
    <script>
        ...
        function <?php echo $funcid; ?>_clearsearch(_frm){
            ...
            _asr.setvaluebyname(_frm,"trade_id","");
    ...
    <?php echo W('Summary/javascript',array('LogTradeSummary'));?>
