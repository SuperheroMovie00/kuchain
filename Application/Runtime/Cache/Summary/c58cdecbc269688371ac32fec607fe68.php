...
<div toplayer="1" class="wrap-box wrap-nmd wrap-style00 " id="<?php echo $funcid;?>" summaryid="MessageSendSummary" baseurl="<?php echo U('MessageSendSummary/index'); ?>">
  <div class="wrap-box-info ">

    <div class="wrap-title abe-ofl">
      <div class="tit abe-fl" style="width: 450px;">消息发送列表</div>
      <div class="abe-fl">
        <div class="textbox" >
          <div  id="<?php echo "$funcid"; ?>-keyword-info" class="abe-fl"<?php if($search["_showsearch"]=="show"):?>style="display:none;"<?php endif; ?>>
             ...
             <input type="button" value="搜索" class="btn btn-org  mrg_10 " id="<?php echo $funcid;?>-keyword-search"  default-status="1"  onclick="<?php echo ($funcid); ?>_keyword_set(); return _asr.submit('<?php echo "$funcid"; ?>', '<?php echo "$funcid"; ?>-Search', '<?php echo U("MessageSendSummary/index?func=search&") ; ?>',''); " />
             <input id="<?php echo $funcid;?>-search-buttc" type="button" value="导出" class="btn btn-blue mrg_10 " default-status="1" onclick="return _asr.showExport('<?php echo "$funcid"; ?>', '<?php echo "$funcid"; ?>-Search', '<?php echo U("MessageSendSummary/index?func=export&") ; ?>',<?php echo $p ?>); " />
          </div>
    ...
    <div class="screening"  >
      <form action="<?php echo U('MessageSendSummary/index?func=search'); ?>" id="<?php echo "$funcid"; ?>-Search" method="get">
                      ...
                      <div class="unit-mid">
                          <div class="dropdown" id="<?php echo ($funcid); ?>_status">
                             <select class="pbsele dropdown0" name="status">
                               ...
                               <?php
 $keyvalue = table_MessageSend_status(); if(is_array($keyvalue)){ $i = 0; $__LIST__ = $keyvalue; ?>
                      ...
                      <div class="unit-mid">
                          <div class="dropdown" id="<?php echo ($funcid); ?>_type">
                             <select class="pbsele dropdown0" name="type">
                               ...
                               <?php
 $keyvalue = table_MessageSend_type(); if(is_array($keyvalue)){ $i = 0; $__LIST__ = $keyvalue; ?>
                                      <?php foreach($__LIST__ as $key=>$item): ++$i; ?>
                  ...
                  <li>
                      <div class="unit-left"> 发送途径</div>
                      <div class="unit-mid">
                          <div class="dropdown" id="<?php echo ($funcid); ?>_send">
                             <select class="pbsele dropdown0" name="send">
                                <option value="" <?php if($search['send'] == ''): ?> selected="selected" <?php endif;?> ></option>
                               <?php
 $keyvalue = table_MessageSend_send(); if(is_array($keyvalue)){ $i = 0; $__LIST__ = $keyvalue; ?>
                                      <?php foreach($__LIST__ as $key=>$item): ++$i; ?>
                                   <option value="<?php echo $item['id']; ?>" <?php if($item['id'] == $search['send']): ?> selected="selected" <?php endif;?>><?php echo charlevel($item['level']).$item['name']; ?></option>
                                      <?php endforeach; ?>
                               <?php } ?>
                             </select>
                          </div>
                  ...
                  <li>
                      <div class="unit-left"> 模板代码</div>
                      <div class="unit-mid">
                          <div class="textbox">
                              <input type="text" class="pbtxt txt0" name="message_templet_code"  value="<?php echo $search['message_templet_code']; ?>"   placeholder=" 输入%可进行匹配模糊搜索 ">
                          </div>
                          <div class="prompt" style="display:none">
                              <div class="error"><i class="iconfont">&#xe616;</i></div>
                          </div>
                  ...
                  <li>
                      <div class="unit-left"> 邮箱</div>
                      <div class="unit-mid">
                          <div class="textbox">
                              <input type="text" class="pbtxt txt0" name="email"  value="<?php echo $search['email']; ?>"   placeholder=" 输入%可进行匹配模糊搜索 ">
                          </div>
                          <div class="prompt" style="display:none">
                              <div class="error"><i class="iconfont">&#xe616;</i></div>
                          </div>
                  ...
                  <li>
                      <div class="unit-left"> 微信</div>
                      <div class="unit-mid">
                          <div class="textbox">
                              <input type="text" class="pbtxt txt0" name="wechat_openid"  value="<?php echo $search['wechat_openid']; ?>"   placeholder=" 直接进行模糊搜索 ">
                          </div>
                          <div class="prompt" style="display:none">
                              <div class="error"><i class="iconfont">&#xe616;</i></div>
                          </div>
                  ...
                  <div class="sub-box sub-box3">
                    <div class="pbtab abe-fl" >
                      ...
                      <a href="#" onclick="return _asr.tabsheet('<?php echo $funcid;?>', '<?php echo "$funcid"; ?>-Search', 'weifasong');" <?php if($search['_tab'] == 'weifasong'): ?> class="current"<?php endif;?>>未发送</a>
                      <a href="#" onclick="return _asr.tabsheet('<?php echo $funcid;?>', '<?php echo "$funcid"; ?>-Search', 'yifasong');" <?php if($search['_tab'] == 'yifasong'): ?> class="current"<?php endif;?>>已发送</a>
          ...
          <?php if (isset($rights['search']) && $rights['search']): ?>
               <input type="button" value="搜索" class="btn btn-org  mrg_10 " onclick="return _asr.submit('<?php echo "$funcid"; ?>', '<?php echo "$funcid"; ?>-Search', '<?php echo U("MessageSendSummary/index?func=search&") ; ?>',''); " />
          <?php endif; ?>
          ...
          <?php if (isset($rights['export']) && $rights['export']): ?>
               <input type="button" value="导出" class="btn btn-blue mrg_10 " onclick="return _asr.showExport('<?php echo "$funcid"; ?>', '<?php echo "$funcid"; ?>-Search', '<?php echo U("MessageSendSummary/index?func=export&") ; ?>',<?php echo $p ?>); " />
          <?php endif; ?>

                    <em class="pdr_20"></em>
                    <a href="javascript:void(0);" class="table-set <?php echo count($colshow)>0?"vi-blue":"abe-gray3"; ?>"  onclick="return _asr.popupFun('<?php echo U("/Summary/MessageSendSummary/index?func=columnsetting&") ; ?>','<?php echo filterFuncId("/MessageSendSummary/column","");?>');  " ><em class="iconfont abe-ft14 mrg_5">&#xe60a;</em>设置</a>
                    </div>
                  </div>
      </form>
    </div>
  ...
  <div class="wrap-nmd-box">
    <div class="wrap-master ">
      ...
      <div class="list-scroll">
        <div class="table-box">
          <div class="table-in">
            <form id="<?php echo "$funcid"; ?>-Result"  action="<?php U('MessageSendSummary/op'); ?>" method="post">
          ...
          <!-- 序号        <col style="width: 40px ;">   -->
                           ...
                           <col style="width: 80px ; <?php if(isset($colshow["user_id"]) && $colshow["user_id"]=="0"): ?>display:none;<?php endif; ?> ">  <!-- 用户 -->
                           <col style="width: 80px ; <?php if(isset($colshow["type"]) && $colshow["type"]=="0"): ?>display:none;<?php endif; ?> ">  <!-- 信息类型 -->
                           <col style="width: 80px ; <?php if(isset($colshow["send"]) && $colshow["send"]=="0"): ?>display:none;<?php endif; ?> ">  <!-- 发送途径 -->
                           <col style="width: 80px ; <?php if(isset($colshow["message_templet_code"]) && $colshow["message_templet_code"]=="0"): ?>display:none;<?php endif; ?> ">  <!-- 模板代码 -->
                           <col style="width: 100px ; <?php if(isset($colshow["email"]) && $colshow["email"]=="0"): ?>display:none;<?php endif; ?> ">  <!-- 邮箱 -->
                           <col style="width: 80px ; <?php if(isset($colshow["mobile"]) && $colshow["mobile"]=="0"): ?>display:none;<?php endif; ?> ">  <!-- 手机 -->
                           <col style="width: 100px ; <?php if(isset($colshow["wechat_openid"]) && $colshow["wechat_openid"]=="0"): ?>display:none;<?php endif; ?> ">  <!-- 微信 -->
          ...
          <!-- 序号       <th>序号</th>   -->
                          ...
                          <th <?php if(isset($colshow["user_id"]) && $colshow["user_id"]=="0"): ?> style="display:none" <?php endif; ?>>用户</th>
                          <th <?php if(isset($colshow["type"]) && $colshow["type"]=="0"): ?> style="display:none" <?php endif; ?>>信息类型</th>
                          <th <?php if(isset($colshow["send"]) && $colshow["send"]=="0"): ?> style="display:none" <?php endif; ?>>发送途径</th>
                          <th <?php if(isset($colshow["message_templet_code"]) && $colshow["message_templet_code"]=="0"): ?> style="display:none" <?php endif; ?> class="abe-txtl">模板代码</th>
                          <th <?php if(isset($colshow["email"]) && $colshow["email"]=="0"): ?> style="display:none" <?php endif; ?> class="abe-txtl">邮箱</th>
                          <th <?php if(isset($colshow["mobile"]) && $colshow["mobile"]=="0"): ?> style="display:none" <?php endif; ?> class="abe-txtl">手机</th>
                          <th <?php if(isset($colshow["wechat_openid"]) && $colshow["wechat_openid"]=="0"): ?> style="display:none" <?php endif; ?> class="abe-txtl">微信</th>
                        ...
                        <?php if(is_array($list)): $i = 0; $__LIST__ = $list; if( count($__LIST__) == 0) : echo ""; else: foreach($__LIST__ as $key=>$master): $mod = ($i % 2 );++$i; ?>
                                  ...
                                  <!-- 序号 -->
                                  <td style=" <?php if(isset($colshow["status"]) && $colshow["status"]=="0"): ?>display:none<?php endif; ?> " ><?php echo get_table_MessageSend_status("$master[status]","name","") ; ?></td>
                                  <td style=" <?php if(isset($colshow["user_id"]) && $colshow["user_id"]=="0"): ?>display:none<?php endif; ?> " ><?php echo $master["user_id"] ; ?></td>
                                  <td style=" <?php if(isset($colshow["type"]) && $colshow["type"]=="0"): ?>display:none<?php endif; ?> " ><?php echo get_table_MessageSend_type("$master[type]","name","") ; ?></td>
                                  <td style=" <?php if(isset($colshow["send"]) && $colshow["send"]=="0"): ?>display:none<?php endif; ?> " ><?php echo get_table_MessageSend_send("$master[send]","name","") ; ?></td>
                                  <td style=" <?php if(isset($colshow["message_templet_code"]) && $colshow["message_templet_code"]=="0"): ?>display:none<?php endif; ?> " class=" abe-txtl "><?php echo $master["message_templet_code"] ; ?></td>
                                  <td style=" <?php if(isset($colshow["email"]) && $colshow["email"]=="0"): ?>display:none<?php endif; ?> " class=" abe-txtl "><?php echo $master["email"] ; ?></td>
                                  <td style=" <?php if(isset($colshow["mobile"]) && $colshow["mobile"]=="0"): ?>display:none<?php endif; ?> " class=" abe-txtl "><?php echo $master["mobile"] ; ?></td>
                                  <td style=" <?php if(isset($colshow["wechat_openid"]) && $colshow["wechat_openid"]=="0"): ?>display:none<?php endif; ?> " class=" abe-txtl "><?php echo $master["wechat_openid"] ; ?></td>
    ...
    <script>
        ...
        function <?php echo $funcid; ?>_clearsearch(_frm){
            ...
            _asr.setvaluebyname(_frm,"send","");
            _asr.setvaluebyname(_frm,"message_templet_code","");
            _asr.setvaluebyname(_frm,"email","");
            _asr.setvaluebyname(_frm,"mobile","");
            _asr.setvaluebyname(_frm,"wechat_openid","");
    ...
    <?php echo W('Summary/javascript',array('MessageSendSummary'));?>
